  ...
  var e = {
      9: (e) => {
        e.exports = class {
          ...
          static split(e, t, s = {}) {
            s = s || {}
            const { trim: n, discard_empty: r } = s,
              i = []
            s.trim && i.push((e) => e.map((e) => e.trim())),
              s.discard_empty && i.push((e) => e.filter((e) => e.length > 0))
            let o = e.split(t)
            for (const e of i) o = e(o)
            return o
          }
        }
      },
      73: (e, t, s) => {
        const { RemoveFromArrayDetachable: n } = s(498),
          { TTopics: r } = s(868),
          { install_in_instance: i } = s(912)
        e.exports = {
          install_in_instance: (e, { parameters: t }) => {
            const s = e._get_merged_static_array("TOPICS")
            e._.topics = {}
            for (const t of s) e._.topics[t] = { listeners_: [] }
            e.mixin(r, {
              pub: (t, s) => {
                if (t.includes("!"))
                  throw new Error('"!" in event name reserved for future use')
                const n = e._.topics[t]
                if (n) for (const e of n.listeners_) e()
                else console.warn("missing topic: " + n)
              },
              sub: (t, s) => {
                const r = e._.topics[t]
                if (r) return r.listeners_.push(s), new n(r.listeners_, s)
                console.warn("missing topic: " + r)
              },
            })
          },
        }
        ...
        e.exports = {
          ...
          display_time: (e) => {
            const t = (e) => String(e).padStart(2, "0"),
              ...
              n = t(e.getMonth() + 1),
              r = t(e.getDate()),
              i = `${t(e.getHours())}:${t(e.getMinutes())}:${t(
                e.getSeconds()
              )}`,
              o = s !== a.getFullYear(),
              c = o || e.getMonth() !== a.getMonth(),
              l = c || e.getDate() !== a.getDate()
            return o
              ? `${s}-${n}-${r} ${i}`
              : c
              ? `${n}-${r} ${i}`
      ...
      294: (e, t, s) => {
        const { AdvancedBase: n } = s(952),
          { Service: r } = s(866),
          { ServiceManager: i } = s(875),
          o = s(868)
        e.exports = {
          AdvancedBase: n,
          system: { ServiceManager: i },
          libs: {
            promise: s(717),
            context: s(475),
            listener: s(498),
        ...
        e.exports = {
          ...
          install_in_instance: (e, { parameters: t }) => {
            ...
            ;(e.onchange = (t, s) => {
              ...
              (e._.properties = {})
            for (const n in s) {
              const r = { definition: s[n], listeners: [], value: void 0 }
              e._.properties[n] = r
              let i = null
              if (
                ("object" == typeof s[n]
                  ? ((i = s[n]),
                    i.factory && (i.value = i.factory({ parameters: t })))
                  : "function" == typeof s[n] && ((i = {}), (i.value = s[n]())),
                null === i)
              )
              ...
              if (
                ...
                const r = "string" == typeof s[n].construct ? s[n].construct : n
                e[n] = t[r]
              }
            }
          },
      ...
      346: (e, t, s) => {
        ...
        class o extends n {
          ...
          static IMPLEMENTS = {
            [r]: {
              log(e, t, s, n) {
                const r = (0, this.require)("util"),
                  i = this.format[e]
                let o = ""
                ;(o += `${i.ansii}[${e.toUpperCase()}][0m `),
                  (o += t),
                  Object.keys(s).length &&
                    ...
                    (o +=
                      Object.entries(s)
                        .map(([e, t]) => `\n  ${e}=${r.inspect(t)}`)
                        .join(" ") + "\n")),
                  (this.console ?? console)[i.err ? "error" : "log"](o, ...n)
              },
            },
          }
        }
        class a extends n {
          static PROPERTIES = {
            ...
            delegate: { construct: !0, value: null, adapt: (e) => i(e, r) },
          }
          static IMPLEMENTS = {
            [r]: {
              log(e, t, s, n) {
        ...
        e.exports = {
          ...
          CategorizedToggleLogger: class extends n {
            ...
            static IMPLEMENTS = {
              [r]: {
                log(e, t, s, n) {
                  const r = s.category
                  if (this.categories[r]) return this.delegate.log(e, t, s, n)
                },
              },
            }
            on(e) {
          ...
          ToggleLogger: class extends n {
            ...
            static IMPLEMENTS = {
              [r]: {
                log(e, t, s, n) {
                  if (this.enabled) return this.delegate.log(e, t, s, n)
                },
              },
            }
          },
        ...
        e.exports = class {
              ...
              (this.storeSet = (e, t) => {
                this.store.set(e, t),
                  ...
                  this.isIndexedDBAvailable &&
                    this.db &&
                    this._persistToIndexedDB(e, t)
              }),
              this._initIndexedDB()
          }
          _initIndexedDB() {
            "undefined" != typeof window && window.indexedDB && this.dbName
              ? ((this.isIndexedDBAvailable = !0),
          ...
          async _persistExpirationToIndexedDB(e, t) {
            if (this.db)
              try {
                const s = this.db
                  .transaction(["expireTimes"], "readwrite")
                  .objectStore("expireTimes")
            ...
            if (
              ...
              void 0 !== g
                ...
                void 0 !== t &&
                  ...
                  this.isIndexedDBAvailable &&
                    this.db &&
                    this._persistExpirationToIndexedDB(e, t))
            } else
              this.expireTimes.delete(e),
                this.isIndexedDBAvailable &&
                  this.db &&
                  this._persistExpirationToIndexedDB(e, void 0)
            return !p || v
          }
          get(e) {
          ...
          exists(...e) {
            let t = 0
            for (const s of e)
              this._checkAndRemoveExpiredKey(s) || (this.store.has(s) && t++)
            return t
          }
          incr(e) {
          ...
          expire(e, t, s = {}) {
            ...
            const { NX: n = !1, XX: r = !1, GT: i = !1, LT: o = !1 } = s,
              a = Date.now(),
          ...
          expireat(e, t, s = {}) {
            ...
            const { NX: n = !1, XX: r = !1, GT: i = !1, LT: o = !1 } = s,
              a = 1e3 * t - Date.now()
            if (a <= 0)
              return this.store.delete(e), this.expireTimes.delete(e), 0
            const c = this.pttl(e)
            return (r && -1 === c) ||
              (n && -1 !== c) ||
              (i && -1 !== c && a <= c) ||
          ...
          pexpire(e, t, s = {}) {
            const { NX: n = !1, XX: r = !1, GT: i = !1, LT: o = !1 } = s
            if ((n && this.store.has(e)) || (r && !this.store.has(e))) return 0
            if (i || o) {
              const s = this.pttl(e)
          ...
          pexpireat(e, t) {
            const s = t - Date.now()
            return s <= 0
              ? (this.store.delete(e), this.expireTimes.delete(e), 0)
              : this.pexpire(e, s)
          }
          pttl(e) {
          ...
          getrange(e, t, s) {
            const n = this.get(e)
            return "string" != typeof n ? "" : n.slice(t, s + 1)
          }
          getset(e, t) {
            const s = this.get(e)
          ...
          setrange(e, t, s) {
            ...
            let n = this.get(e)
            ;(void 0 !== n && void 0 !== n) || (n = "")
            const r = n.slice(0, t) + s + n.slice(t + s.length)
          ...
          rename(e, t) {
            ...
            return (
              ...
              this.store.delete(e),
              void 0 !== n &&
                (this.expireTimes.set(t, n), this.expireTimes.delete(e)),
              !0
            )
          }
          type(e) {
          ...
          sadd(e, ...t) {
            ...
            let n = 0
            for (const e of t) s.has(e) || (s.add(e), n++)
            return n
          }
          scard(e) {
          ...
          sinter(...e) {
            ...
            for (let e = 1; e < t.length; e++)
              for (const n of s) t[e].has(n) || s.delete(n)
            return Array.from(s)
          }
          sintercard(...e) {
          ...
          smove(e, t, s) {
            ...
            const r = this.store.get(t) || new Set()
            if (!(r instanceof Set))
              throw new Error(
                "ERR Operation against a key holding the wrong kind of value"
              )
            return n.delete(s), r.add(s), this.storeSet(t, r), 1
          }
          spop(e, t = 1) {
            const s = this.store.get(e)
            if (void 0 === s) return []
          ...
          srem(e, ...t) {
            ...
            let n = 0
            for (const e of t) s.delete(e) && n++
            return n
          }
          sscan(e, t, s = {}) {
            const { match: n = "*", count: r = 10 } = s,
              i = this.store.get(e)
            ...
            const o = new RegExp(n.replace("*", ".*")),
              ...
              c = []
            let l = t
            for (let e = t; e < a.length && c.length < r; e++)
              o.test(a[e]) && c.push(a[e]), (l = e + 1)
          ...
          ltrim(e, t, s) {
            ...
            const r = n.length,
              i = t >= 0 ? t : Math.max(r + t, 0),
              o = s >= 0 ? s : Math.max(r + s, -1),
              a = n.slice(i, o + 1)
          ...
          lrem(e, t, s) {
            ...
            let r = 0
            if (t > 0)
              for (let e = 0; e < n.length && r < t; e++)
                n[e] === s && (n.splice(e, 1), r++, e--)
            else if (t < 0)
              for (let e = n.length - 1; e >= 0 && r < -t; e--)
                n[e] === s && (n.splice(e, 1), r++)
            else
              (r = n.filter((e) => e === s).length),
                this.storeSet(
                  e,
                  n.filter((e) => e !== s)
                )
          ...
          lmove(e, t, s, n) {
            const r = "LEFT" === n ? "lpush" : "rpush",
              i = this["LEFT" === s ? "lpop" : "rpop"](e)
            return void 0 === i ? null : (this[r](t, i), i)
          }
          lmpop(e, t, s) {
            const n = "LEFT" === s ? "lpop" : "rpop",
              r = []
            for (let s = 0; s < e; s++) {
              const e = this[n](t)
              if (void 0 === e) break
          ...
          lpos(e, t, s = {}) {
            const { rank: n = 0, start: r = 0, stop: i = -1 } = s,
              o = this.store.get(e)
            if (void 0 === o || !Array.isArray(o)) return
            let a = 0
            const c = o.length,
              l = r >= 0 ? r : Math.max(c + r, 0),
            ...
            for (; Date.now() < n; )
              for (let e = 0; e < t.length; e++) {
                ...
                if (void 0 !== n && Array.isArray(n) && n.length > 0) {
                  const e = n.pop()
                  return 0 === n.length && this.store.delete(s), [s, e]
                }
              }
            return null
          }
          ...
          zadd(e, t, s) {
            return this._checkAndRemoveExpiredKey(e)
              ...
              : (this.store.has(e) || this.storeSet(e, new n()),
                this.store.get(e).set(s, Number(t)),
                1)
          }
          zcard(e) {
            return this._checkAndRemoveExpiredKey(e)
          ...
          zcount(e, t, s) {
            ...
            const n = this.store.get(e)
            let r = 0
            for (const e of n.values()) e >= t && e <= s && r++
            return r
          }
          zdiff(...e) {
            if (0 === e.length) return new Set()
            const t = e.map((e) =>
                this._checkAndRemoveExpiredKey(e)
                  ? new n()
                  : this.store.get(e) || new n()
              ),
              s = new Set(t[0].keys())
            for (let e = 1; e < t.length; e++)
              for (const n of t[e].keys()) s.delete(n)
            return s
          }
          zdiffstore(e, ...t) {
          ...
          zinter(...e) {
            ...
            for (let e = 1; e < t.length; e++) {
              const n = new Set()
              for (const r of t[e].keys()) s.has(r) && n.add(r)
              s.clear()
          ...
          zrange(e, t, s) {
            const r = this.store.get(e) || new n(),
              i = Array.from(r.entries()).sort((e, t) => e[1] - t[1])
            return (
              t < 0 && (t = i.length + t),
              s < 0 && (s = i.length + s),
          ...
          zrangebylex(e, t, s, r = {}) {
            ...
            let o = Array.from(i.keys())
              ...
              .filter((e) => e >= t && e <= s)
            if (r.limit) {
              const { offset: e, count: t } = r.limit
              o = o.slice(e, e + t)
            }
            return o
          }
          zrangebyscore(e, t, s, r = {}) {
            const i = this.store.get(e) || new n()
            let o = Array.from(i.entries())
              .sort((e, t) => e[1] - t[1])
              .filter(([, e]) => e >= t && e <= s)
            if (
              ((o = r.withscores
          ...
          zrangestore(e, t, s, r) {
            ...
            s < 0 && (s = o.length + s), r < 0 && (r = o.length + r)
            const a = new n(o.slice(s, r + 1))
            return this.storeSet(e, a), a.size
          }
          zrank(e, t) {
            const s = this.store.get(e)
            if (!s) return
            const n = Array.from(s.entries()).sort((e, t) => e[1] - t[1])
            for (let e = 0; e < n.length; e++) if (n[e][0] === t) return e
          }
          zrem(e, ...t) {
            const s = this.store.get(e)
            if (!s) return 0
          ...
          zremrangebylex(e, t, s) {
            ...
            let i = 0
            for (const e of r) e >= t && e <= s && (n.delete(e), i++)
            return i
          }
          zremrangebyrank(e, t, s) {
            const n = this.store.get(e)
            if (!n) return 0
            const r = Array.from(n.entries()).sort((e, t) => e[1] - t[1])
            t < 0 && (t = r.length + t), s < 0 && (s = r.length + s)
            let i = 0
            for (let e = t; e <= s; e++) n.delete(r[e][0]) && i++
            return i
          }
          zremrangebyscore(e, t, s) {
            ...
            const r = Array.from(n.entries()).sort((e, t) => e[1] - t[1])
            let i = 0
            for (const [e, o] of r) o >= t && o <= s && (n.delete(e), i++)
            return i
          }
          zrevrange(e, t, s) {
            const r = this.store.get(e) || new n(),
              i = Array.from(r.entries()).sort((e, t) => t[1] - e[1])
            return (
              t < 0 && (t = i.length + t),
              s < 0 && (s = i.length + s),
              i.slice(t, s + 1).map(([e, t]) => [e, t])
          ...
          zrevrank(e, t) {
            const s = this.store.get(e)
            if (!s) return
            const n = Array.from(s.entries()).sort((e, t) => t[1] - e[1])
            for (let e = 0; e < n.length; e++) if (n[e][0] === t) return e
          }
          zscan(e, t, s = {}) {
            const r = this.store.get(e) || new n(),
            ...
            for (; a > 0 && c < i.length; )
              (s.match &&
                !new RegExp(s.match.replace("*", ".*")).test(i[c][0])) ||
                (o.push(i[c]), a--),
                c++
          ...
          zunion(e) {
            ...
            for (const s of e) {
              ...
              if (e)
                for (const [s, n] of e.entries()) t.set(s, (t.get(s) || 0) + n)
            }
          ...
          geoadd(e, t, s, r) {
            ...
            const i = this.store.get(e) || new n()
            if (!i.get(r)) {
              const n = { longitude: t, latitude: s }
              return i.set(r, n), this.storeSet(e, i), 1
            }
            return 0
          }
          geodist(e, t, s, n = "m") {
            ...
            const i = r.get(t),
              o = r.get(s)
            if (!i || !o) return
            const a = this._haversineDistance(
              i.latitude,
              i.longitude,
              o.latitude,
              o.longitude
          ...
          georadius(e, t, s, n, r = "m") {
            const i = this.store.get(e)
            if (!i) return []
            const o = this._convertDistance(n, r, "m"),
              a = []
            for (const [e, n] of i.entries())
              this._haversineDistance(s, t, n.latitude, n.longitude) <= o &&
                a.push(e)
            return a
          }
          georadius_ro(e, t, s, n) {
            return this.georadius(e, t, s, n, !0)
          }
          georadiusbymember(e, t, s) {
            const n = this.geopos(e, t)
            if (n) return this.georadius(n[0], n[1], s, e)
          }
          georadiusbymember_ro(e, t, s) {
            const n = this.geopos(e, t)
            if (n) return this.georadius(n[0], n[1], s, e, !0)
          }
          geosearch(e, t, s, n) {
            return this.georadius(t, s, n, e)
          }
          geosearchstore(e, t, s, n, r) {
            const i = this.georadius(s, n, r, t)
            return this.set(e, i), i.length
          }
          scan(e, t = "*", s = 10) {
            const n = this.keys(t),
              r = Math.min(e + s, n.length)
            return [r === n.length ? 0 : r, n.slice(e, r)]
          }
          sort(e, t = "ASC", s = !1) {
            const n = this.store.get(e)
          ...
          hincrby(e, t, s) {
            const r = this.store.get(e) || new n(),
              i = parseInt(r.get(t) || 0, 10) + s
            return r.set(t, i.toString()), this.storeSet(e, r), i
          }
          hincrbyfloat(e, t, s) {
            const r = this.store.get(e) || new n(),
              i = parseFloat(r.get(t) || 0) + s
            return r.set(t, i.toString()), this.storeSet(e, r), i
          }
          hkeys(e) {
            const t = this.store.get(e)
          ...
          hsetnx(e, t, s) {
            const r = this.store.get(e) || new n()
            return r.has(t) ? 0 : (r.set(t, s), this.storeSet(e, r), 1)
          }
          hstrlen(e, t) {
            const s = this.store.get(e),
              n = s ? s.get(t) : null
          ...
          hscan(e, t, s = "*", r = 10) {
            const i = this.store.get(e) || new n(),
              ...
              a = Math.min(t + r, o.length)
            return [
              a === o.length ? 0 : a,
              o.slice(t, a).map((e) => [e, i.get(e)]),
            ]
          }
          hexists(e, t) {
            const s = this.store.get(e)
          ...
          _initCleanupLoop(e) {
            1 === this.store.size &&
              ((this.cleanupLoop = setInterval(() => {
                if (0 === this.store.size && this.cleanupLoop)
                  clearInterval(this.cleanupLoop)
                else
                  for (const e of this.expireTimes.keys())
                    this._checkAndRemoveExpiredKey(e)
              }, e)),
          ...
          _haversineDistance(e, t, s, n) {
            const r = (e) => (e * Math.PI) / 180,
              i = r(s - e),
              o = r(n - t),
              a =
          ...
          _convertDistance(e, t, s) {
            const n = { m: 1, km: 0.001, mi: 621371e-9, ft: 3.28084 }
            if (!n[t] || !n[s]) throw new Error("Invalid distance unit")
            return (e * n[t]) / n[s]
          }
          _encodeGeohash(e, t) {
            let s = "",
            ...
            for (; s.length < 12; ) {
              if (a) {
                ...
                const t = (n + r) / 2
                e > t ? ((l = 1 + (l << 1)), (n = t)) : ((l <<= 1), (r = t))
              }
              ;(a = !a),
                c < 4
                  ? c++
                  : ((s += "0123456789bcdefghjkmnpqrstuvwxyz"[l]),
                    (c = 0),
                    (l = 0))
            }
            return s
      ...
      475: (e) => {
        class t {
          ...
          follow(e, t) {
            const s = {}
            for (const n of t) Object.defineProperty(s, n, { get: () => e[n] })
            return this.sub(s)
          }
          sub(e) {
            void 0 === e && (e = {})
            ...
            for (const e in r) n[e] || Object.defineProperty(s, e, r[e])
            return s
          }
        }
        e.exports = { Context: t }
        ...
        e.exports = {
          ...
          ansi_visible_length: (e) =>
            [
              ...
              { name: "osc8:end", re: /\x1B\]8;;(?:\x07|\x1B\\)/g },
              { name: "csi", re: /\x1B\[[0-?]*[ -/]*[@-~]/g },
            ].reduce((e, { re: t }) => e.replace(t, ""), e).length,
        }
      },
      533: (e, t, s) => {
        ...
        class t {
          ...
          set(e, t) {
            ...
            return (
              !s.has(e) &&
                s.size >= 8388608 &&
                (this.#e.unshift(new Map()), (s = this.#e[0])),
              s.set(e, t),
              this
            )
          }
          ...
          *entries() {
          ...
          forEach(e, t) {
            for (const [s, n] of this) e.call(t, n, s, this)
          }
        }
        e.exports = t
      },
          ...
          install_in_instance: (e) => {
            ...
            for (const s in t) {
              ...
              ;(e._.nariMethods[s] = r),
                (e[s] = async (...e) => {
                  const t =
                      n.firstarg_options && "object" == typeof e[0]
                        ? 0
                        : n.positional.length,
                    s = e.slice(0, t),
                    i = e.slice(t),
                    ...
                    a = {},
                    c = {}
                  for (const [e, t] of s.entries()) o[n.positional[e]] = t
                  let l
                  "object" == typeof i[0] &&
                    (Object.assign(a, i[0]), i.shift()),
                    "function" == typeof i[0]
                      ? ((c.success = i[0]), i.shift())
      ...
      777: (e) => {
        class t {
          _get_inheritance_chain() {
            ...
            for (; s && s !== t; ) e.push(s), (s = s.__proto__)
            return e.reverse()
          }
          _get_merged_static_array(e) {
            ...
            let n = null
            for (const r of t)
              r[e] && r[e] !== n && ((n = r[e]), s.push(...r[e]))
            return s
          }
          _get_merged_static_object(e) {
            const t = this._get_inheritance_chain(),
              s = {}
            for (const n of t) n[e] && Object.assign(s, n[e])
            return s
          }
        }
        ...
        e.exports = {
          ...
          Service: class extends n {
            ...
            static create({ parameters: e, context: t }) {
              const s = new this()
              return (s._.context = t), s.as(o).construct(e), s
            }
            static IMPLEMENTS = {
              [o]: {
                init(...e) {
      ...
      875: (e, t, s) => {
        const { AdvancedBase: n } = s(952),
          ...
          i = "running"
        e.exports = {
          ServiceManager: class extends n {
            ...
            get(e) {
              ...
              if (t.status === i) return t.instance
            }
            async aget(e) {
              ...
              await new Promise((s) => {
                ;(t = () => {
                  if (0 === this.get_waiting_for_(e).length) {
                    ...
                    return (
                      -1 !== e && this.init_listeners_.splice(e, 1), s(), !0
                    )
                  }
                }),
            ...
            get_waiting_for_(e) {
              ...
              for (const s of e) {
                ...
                e ? e.status !== i && t.push(s) : t.push(s)
              }
              return t
            }
            async maybe_init_(e) {
              const t = this.services_m_[e],
                s = t.instance.as(r).get_depends(),
                n = this.get_waiting_for_(s)
              if (0 !== n.length) {
                for (const t of n)
                  this.waiting_[t] || (this.waiting_[t] = new Set()),
                    this.waiting_[t].add(e)
                ;(t.status = "pending"), (t.statusWaitingFor = n)
              } else await this.init_service_(e)
            }
            async init_service_(e, t = {}) {
              const s = this.services_m_[e]
              s.status = "initializing"
              const n = s.instance.as(r)
              await n.init(), (s.status = i), (s.statusStartTS = new Date())
              const o = this.waiting_[e],
                a = []
              if (o)
                for (const e of o.values())
                  a.push(this.maybe_init_(e, { no_init_listeners: !0 }))
              if ((await Promise.all(a), !t.no_init_listeners))
          ...
          install_in_instance(t, { parameters: s }) {
            ...
            ;(n.listeners_ = {}),
              ...
              (t.emit = async (e, t, s) => {
                ...
                const r = e.split("."),
                  i = []
                for (let r = 0; r < n.global_listeners_.length; r++) {
                  let o = n.global_listeners_[r]
                  for (const e of n.callbackDecorators) o = e(o)
                  i.push(o(e, t, { ...s, key: e }))
                }
      ...
      912: (e, t, s) => {
        e.exports = {
          install_in_instance: (e, { parameters: t }) => {
            ...
            if (t.modules) for (const e in t.modules) n[e] = t.modules[e]
            ;(e.modules = n),
              (e.require = (t) => (e.modules[t] ? e.modules[t] : s(274)(t)))
          },
        }
      },
      952: (e, t, s) => {
    ...
    (() => {
      ...
      const n = class {
          ...
          logRequest(e = {}) {
            ...
            i
              ? console.error(a, { error: i.message || i, result: r })
              : console.log(a, r)
          }
          getStats() {
              ...
              if (
                ...
                if (i.length > 2) {
                  ...
                  ;-1 === e
                    ? ((i = ""), (o = 0))
                    : ((i = i.slice(0, e)),
                      (o = i.length - 1 - i.lastIndexOf(i, s))),
                    (a = h),
                    (c = 0)
                  continue
                }
      ...
      const a = {
          resolve(...e) {
            ...
            for (let n = e.length - 1; n >= -1 && !s; n--) {
              const i = n >= 0 ? e[n] : "/"
              0 !== i.length && ((t = `${i}/${t}`), (s = i.charCodeAt(0) === r))
            }
          ...
          isAbsolute: (e) => e.length > 0 && e.charCodeAt(0) === r,
          join(...e) {
            if (0 === e.length) return "."
            let t
          ...
          relative(e, t) {
            ...
            if (l === o)
              if (i > o) {
                if (t.charCodeAt(1 + l) === r) return t.slice(1 + l + 1)
                if (0 === l) return t.slice(1 + l)
              } else
                n > o &&
                  (e.charCodeAt(1 + l) === r ? (c = l) : 0 === l && (c = 0))
            let h = ""
            for (l = 1 + c + 1; l <= s; ++l)
              (l !== s && e.charCodeAt(l) !== r) ||
                (h += 0 === h.length ? ".." : "/..")
      ...
      ;(l.length = 0),
        ...
        (l.setItem = function (e, t) {
          void 0 === t
            ? l.removeItem(e)
            : (h.hasOwnProperty(e) || l.length++, (h[e] = "" + t))
        }),
      ...
      const u = l,
        ...
        _ = Symbol("timeout"),
        k = Symbol("timedOut"),
        A = Symbol("isResponseText")
      function T(...e) {
        const t = e.reduce((e, t) => e + t.length, 0),
          s = new Uint8Array(t)
        return (
          e.forEach((e, t, n) => {
            const r = n.slice(0, t).reduce((e, t) => e + t.length, 0)
            s.set(e, r)
          }),
          s
        )
      ...
      async function x(e) {
        ...
        switch (t) {
          case "text":
            ...
            break
          case "blob":
            this.response = new Blob([e], { type: n })
            break
          case "arraybuffer":
      ...
      const I = class extends EventTarget {
        onreadystatechange() {}
        set readyState(e) {
          this[d] !== e &&
            ((this[d] = e),
        ...
        get responseText() {
          ...
          if (this[A]) return this.response
        ...
        [w](e) {
          ...
          "function" == typeof this[t] &&
            this.addEventListener(e.type, this[t].bind(this), { once: !0 }),
        ...
        send(e = null) {
          ...
          ;(this[A] = "text" === t),
            ...
            fetch(this[y], {
              ...
              .finally(() => {
                clearTimeout(this[_]), this[w](new CustomEvent("loadstart"))
              })
        }
      }
      "object" == typeof module && module.exports
        ? (module.exports = I)
        : ((globalThis || self).XMLHttpRequestShim = I)
      const E = I
      async function S(e) {
        ...
        return (
          ...
          globalThis.puter?.apiCallLogger?.isEnabled() &&
            (o._puterRequestId = {
              ...
              service: "xhr",
              operation: e.replace(/^\//, ""),
              params: { endpoint: e, contentType: r, responseType: i },
            }),
          o
        )
      }
      ...
      function D(e, t, s, n, r) {
        e.addEventListener("load", async function (e) {
          if (
            ...
            const e = await S(this).catch(() => null)
            globalThis.puter.apiCallLogger.logRequest({
              ...
              error:
                this.status >= 400
                  ? { message: this.statusText, status: this.status }
                  : null,
            })
          }
          return (async function (e, t, s, n, r) {
            const i = await S(r)
            return 401 === r.status
              ? (t &&
                  "function" == typeof t &&
                  t({ status: 401, message: "Unauthorized" }),
                n({ status: 401, message: "Unauthorized" }))
              : 200 !== r.status
              ? (t && "function" == typeof t && t(i), n(i))
              : (!1 === i.success &&
          ...
          return (
            1 !== i.length || "object" != typeof i[0] || Array.isArray(i[0])
              ...
              : ((o = { ...i[0] }),
                ...
                delete o.error),
            r.preprocess &&
              "function" == typeof r.preprocess &&
              (o = r.preprocess(o)),
            await (async function (e, t, s, n, r, i) {
              const o = new q()
              return (
                U(
                  e,
      ...
      async function U(
        ...
        o,
        a,
        c = "text/plain;actually=json",
        l = {}
      ) {
        let h = null
        if (
          (globalThis.puter?.apiCallLogger?.isEnabled() &&
            (h = { interface: n, driver: r, method: i, args: o }),
            ...
            return (
              h &&
                ...
                globalThis.puter.apiCallLogger.logRequest({
                  service: "drivers",
                  operation: `${n}::${i}`,
                  params: { interface: n, driver: r, method: i, args: o },
                  error: {
                    code: "auth_canceled",
        ...
        const u = L.callback(e.success) ?? R,
          d = L.callback(e.error) ?? R,
          p = O("/drivers/call", puter.APIOrigin, void 0, "POST", c)
        h && (p._puterDriverRequestInfo = h),
        ...
        ;(p.onreadystatechange = () => {
          if (2 === p.readyState) {
            if ("application/x-ndjson" !== p.getResponseHeader("Content-Type"))
              return
            g = !0
            const e = (async function* () {
              for (; !y; ) {
                const e = new q()
                if (((f = e.resolve.bind(e)), await e, y)) break
                for (; w.length > 0; ) {
                  const e = w.shift()
                  if ("" === e.trim()) continue
            ...
            return (
              Object.defineProperty(e, "start", {
                ...
                value: async (t) => {
                  ...
                  for await (const n of e) t.enqueue(s.encode(n))
                  t.close()
                },
              }),
              t(e)
          ...
          4 === p.readyState && ((y = !0), g && f?.())
        }),
          (p.onprogress = function () {
            if (!f) return
            const e = p.responseText.slice(m)
            m = p.responseText.length
            let t = !1
            for (let s = 0; s < e.length; s++)
              (b += e[s]), "\n" === e[s] && ((t = !0), w.push(b), (b = ""))
            t && f()
          }),
          p.addEventListener("load", async function (r) {
            if (g) return
            const h = await S(r.target)
            if (
              (this._puterDriverRequestInfo &&
                ...
                globalThis.puter.apiCallLogger.logRequest({
                  ...
                  result: r.status >= 400 || !1 === h?.success ? null : h,
                  error: r.status >= 400 || !1 === h?.success ? h : null,
                }),
              401 === r.status || "token_auth_failed" === h?.code)
            ) {
              ...
              return (
                d &&
                  "function" == typeof d &&
                  d({ status: 401, message: "Unauthorized" }),
                s({ status: 401, message: "Unauthorized" })
              )
            }
            if (r.status && 200 !== r.status) return d(h), s(h)
            {
              if (!1 === h.success && "permission_denied" === h.error?.code)
                return (
                  ...
                  ? U(e, t, s, n, i, o, a, c, l)
                  : (d(h), s(h))
              if (!1 === h.success) return d(h), s(h)
              let r = void 0 !== h.result ? h.result : h
              return (
                l.transform && (r = await l.transform(r)),
                t.success && u(r),
                t(r)
              )
            }
      ...
      async function B(e) {
        const t = new q(),
          s = new FileReader()
        return (
          (s.onloadend = () => t.resolve(s.result)), s.readAsDataURL(e), await t
        )
      }
      function N(e) {
      ...
      const j = (e) => {
        ...
        F = class {
          ...
          async listModels(e) {
            const t = {},
              s = await puter.drivers.call(
                "puter-chat-completion",
                "ai-chat",
                "models"
              )
            return s && s.result && Array.isArray(s.result)
              ? (s.result.forEach((s) => {
                  s.provider &&
                    s.id &&
                    ((e && s.provider !== e) ||
                      (t[s.provider] || (t[s.provider] = []),
          ...
          async listModelProviders() {
            let e = []
            const t = await puter.drivers.call(
              "puter-chat-completion",
              "ai-chat",
              "models"
            )
            return t && t.result && Array.isArray(t.result)
              ? ((e = new Set()),
                t.result.forEach((t) => {
          ...
          img2txt = async (...e) => {
            ...
            if (
              (("string" == typeof e[0] || e[0] instanceof Blob) &&
                (t.source = e[0]),
              e[0].source instanceof Blob && (t.source = await N(e[0].source)),
            ...
            return (
              (("boolean" == typeof e[1] && !0 === e[1]) ||
                ...
                (s = !0),
              await M(["source"], "puter-ocr", "aws-textract", "recognize", {
                test_mode: s ?? !1,
                transform: async (e) => {
                  let t = ""
                  for (let s = 0; s < e?.blocks?.length; s++)
                    "text/textract:LINE" === e.blocks[s].type &&
                      (t += e.blocks[s].text + "\n")
                  return t
                },
              }).call(this, t)
          ...
          txt2speech = async (...e) => {
            ...
            if (
              ...
              if (((r = "aws-polly"), t.engine && !n.includes(t.engine)))
                throw {
            ...
            const i = "openai" === r ? "openai-tts" : "aws-polly"
            return await M(["source"], "puter-tts", i, "synthesize", {
              responseType: "blob",
              test_mode: s ?? !1,
              transform: async (e) => {
                let t
                if ("string" == typeof e) t = e
                else if (e instanceof Blob) t = await B(e)
                    ...
                    }
                  {
                    const s = await e.arrayBuffer(),
                      n = new Blob([s], { type: e.type || void 0 })
                    t = await B(n)
                  }
                }
                const s = new Audio(t)
          ...
          speech2txt = async (...e) => {
            ...
            const t = async (e) => (e instanceof Blob ? await N(e) : e)
            let s = {},
              n = !1
            const r = e[0]
            if (
              ...
              Array.isArray(e[1]) ||
              e[1] instanceof Blob
                ? "boolean" == typeof e[1] && (n = e[1])
                : (s = { ...s, ...e[1] }),
              "boolean" == typeof e[2] && (n = e[2]),
            ...
            return await M([], "puter-speech2txt", "openai-speech2txt", i, {
              test_mode: n,
              transform: async (e) =>
                "text" === a &&
                e &&
          ...
          txt2speech = Object.assign(this.txt2speech, {
            listEngines: async (e = {}) => {
              ...
              "string" == typeof e
                ...
                : e &&
                  "object" == typeof e &&
                  ((t = j(e.provider) || t), (s = { ...e }), delete s.provider),
                "openai" === t && (s.provider = "openai")
              const n = "openai" === t ? "openai-tts" : "aws-polly"
              return await M(["source"], "puter-tts", n, "list_engines", {
                responseType: "text",
              }).call(this, s)
            },
            listVoices: async (e) => {
          ...
          chat = async (...e) => {
            ...
            if (
              ...
              if (
                ...
                e[1] instanceof File && (e[1] = await N(e[1])),
                  (t = {
                    vision: !0,
                    messages: [
            ...
            s.model && (t.model = s.model),
              ...
              (t.model = t.model ?? ""),
              t.model &&
                t.model.startsWith("anthropic/") &&
                (t.model = t.model.replace("anthropic/", "")),
              "claude-3-5-sonnet" === t.model &&
                (t.model = "claude-3-5-sonnet-latest"),
              ("claude-3-7-sonnet" !== t.model && "claude" !== t.model) ||
                (t.model = "claude-3-7-sonnet-latest"),
              ("claude-sonnet-4" !== t.model &&
                "claude-sonnet-4-latest" !== t.model) ||
                (t.model = "claude-sonnet-4-20250514"),
              ("claude-opus-4" !== t.model &&
                "claude-opus-4-latest" !== t.model) ||
                (t.model = "claude-opus-4-20250514"),
              "mistral" === t.model && (t.model = "mistral-large-latest"),
              "groq" === t.model && (t.model = "llama3-8b-8192"),
              "deepseek" === t.model && (t.model = "deepseek-chat"),
              "o1-mini" === t.model && (t.model = "openrouter:openai/o1-mini"),
              t.model &&
                t.model.startsWith("openai/") &&
                ((t.model = t.model.replace("openai/", "")),
                (r = "openai-completion")),
              (t.model.startsWith("agentica-org/") ||
                t.model.startsWith("ai21/") ||
                t.model.startsWith("aion-labs/") ||
                t.model.startsWith("alfredpros/") ||
                t.model.startsWith("alpindale/") ||
                t.model.startsWith("amazon/") ||
                t.model.startsWith("anthracite-org/") ||
                t.model.startsWith("arcee-ai/") ||
                t.model.startsWith("arliai/") ||
                t.model.startsWith("baidu/") ||
                t.model.startsWith("bytedance/") ||
                t.model.startsWith("cognitivecomputations/") ||
                t.model.startsWith("cohere/") ||
                t.model.startsWith("deepseek/") ||
                t.model.startsWith("eleutherai/") ||
                t.model.startsWith("google/") ||
                t.model.startsWith("gryphe/") ||
                t.model.startsWith("inception/") ||
                t.model.startsWith("infermatic/") ||
                t.model.startsWith("liquid/") ||
                t.model.startsWith("mancer/") ||
                t.model.startsWith("meta-llama/") ||
                t.model.startsWith("microsoft/") ||
                t.model.startsWith("minimax/") ||
                t.model.startsWith("mistralai/") ||
                t.model.startsWith("moonshotai/") ||
                t.model.startsWith("morph/") ||
                t.model.startsWith("neversleep/") ||
                t.model.startsWith("nousresearch/") ||
                t.model.startsWith("nvidia/") ||
                t.model.startsWith("openrouter/") ||
                t.model.startsWith("perplexity/") ||
                t.model.startsWith("pygmalionai/") ||
                t.model.startsWith("qwen/") ||
                t.model.startsWith("raifle/") ||
                t.model.startsWith("rekaai/") ||
                t.model.startsWith("sao10k/") ||
                t.model.startsWith("sarvamai/") ||
                t.model.startsWith("scb10x/") ||
                t.model.startsWith("shisa-ai/") ||
                t.model.startsWith("sophosympatheia/") ||
                t.model.startsWith("switchpoint/") ||
                t.model.startsWith("tencent/") ||
                t.model.startsWith("thedrummer/") ||
                t.model.startsWith("thudm/") ||
                t.model.startsWith("tngtech/") ||
                t.model.startsWith("undi95/") ||
                t.model.startsWith("x-ai/") ||
                t.model.startsWith("z-ai/")) &&
                (t.model = "openrouter:" + t.model),
              !t.model || t.model.startsWith("gpt-")
                ? (r = "openai-completion")
                : t.model.startsWith("claude-")
                ? (r = "claude")
                : "meta-llama/Meta-Llama-3.1-8B-Instruct-Turbo" === t.model ||
                  "meta-llama/Meta-Llama-3.1-70B-Instruct-Turbo" === t.model ||
                  "meta-llama/Meta-Llama-3.1-405B-Instruct-Turbo" === t.model ||
                  "google/gemma-2-27b-it" === t.model
                ? (r = "together-ai")
                : t.model.startsWith("mistral-") ||
                  t.model.startsWith("codestral-") ||
                  t.model.startsWith("pixtral-") ||
                  t.model.startsWith("magistral-") ||
                  t.model.startsWith("devstral-") ||
                  t.model.startsWith("mistral-ocr-") ||
                  t.model.startsWith("open-mistral-")
                ? (r = "mistral")
                : [
                ...
                : "grok-beta" === t.model
                ? (r = "xai")
                : t.model.startsWith("grok-")
                ? (r = "openrouter")
                : "deepseek-chat" === t.model || "deepseek-reasoner" === t.model
                ? (r = "deepseek")
                : "gemini-1.5-flash" === t.model ||
                  "gemini-2.0-flash" === t.model
                ? (r = "gemini")
                : t.model.startsWith("openrouter:") && (r = "openrouter"),
              void 0 !== s.stream &&
                "boolean" == typeof s.stream &&
                (t.stream = s.stream),
              s.driver && (r = s.driver)
            ...
            return (
              ...
              await M(["messages"], "puter-chat-completion", r, "complete", {
                test_mode: n ?? !1,
                transform: async (e) => (
          ...
          txt2img = async (...e) => {
            ...
            return (
              "nano-banana" === t.model &&
                (t.model = "gemini-2.5-flash-image-preview"),
              "gemini-2.5-flash-image-preview" === t.model &&
                (n = "gemini-image-generation"),
              await M(["prompt"], "puter-image-generation", n, "generate", {
                responseType: "blob",
                test_mode: s ?? !1,
                transform: async (e) => {
                  let t = new Image()
              ...
              await M(
                ...
                "generate",
                {
                  ...
                  transform: async (e) => {
                    ...
                    if (
                      (e instanceof Blob
                        ? ((t = await B(e)), (s = e.type || "video/mp4"))
                        : "string" == typeof e
                        ? (t = e)
                        : e &&
                          "object" == typeof e &&
                    ...
                    return (
                      ...
                      (n.controls = !0),
                      (n.preload = "metadata"),
                      s && n.setAttribute("data-mime-type", s),
                      n.setAttribute("data-source", t),
                      (n.toString = () => n.src),
                      (n.valueOf = () => n.src),
                      n
                    )
        ...
        z = class {
          ...
          list = async (...e) => {
            ...
            return (
              ...
              M(["uid"], "puter-apps", void 0, "select").call(this, t)
            )
          }
          create = async (...e) => {
            let t = {}
            if ("string" == typeof e[0]) {
              let s = e[1],
                n = e[2] ?? e[0]
              t = { object: { name: e[0], index_url: s, title: n } }
            ...
            return await M(["object"], "puter-apps", void 0, "create").call(
              this,
              t
            )
          }
          update = async (...e) => {
            ...
            if (Array.isArray(e) && "string" == typeof e[0]) {
              ...
              t = { id: { name: e[0] }, object: n }
            }
            return await M(["object"], "puter-apps", void 0, "update").call(
              this,
              t
            )
          }
          get = async (...e) => {
            ...
            return (
              Array.isArray(e) &&
                ...
                (t.id = { name: e[0] })),
              "object" == typeof e[0] && null !== e[0] && (t.params = e[0]),
              M(["uid"], "puter-apps", void 0, "read").call(this, t)
            )
          }
          delete = async (...e) => {
            let t = {}
            return (
              Array.isArray(e) &&
                "string" == typeof e[0] &&
                (t = { id: { name: e[0] } }),
              M(["uid"], "puter-apps", void 0, "delete").call(this, t)
            )
          }
              ...
              new Promise((t, s) => {
                ...
                return (
                  ...
                  new Promise((e, t) => {
                    ...
                    D(s, n.success, n.error, e, t), s.send()
                  })
                )
              })
            )
        ...
        W = class {
          ...
          signIn = (e) => (
            ...
            new Promise((t, s) => {
              let n = this.#t++
              var r = screen.width / 2 - 300,
                i = screen.height / 2 - 300
              const o = window.open(
                  `${
                    puter.defaultGUIOrigin
                  }/action/sign-in?embedded_in_popup=true&msg_id=${n}${
                    window.crossOriginIsolated
                      ? "&cross_origin_isolated=true"
                      : ""
                  }${
                    e.attempt_temp_user_creation
                      ? "&attempt_temp_user_creation=true"
                      : ""
                  }`,
                  "Puter",
                  `toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=no, resizable=no, copyhistory=no, width=600, height=600, top=${i}, left=${r}`
                ),
                a = setInterval(() => {
                  o.closed &&
                    (clearInterval(a),
              ...
              function c(e) {
                e.data.msg_id == n &&
                  ...
                  delete e.data.msg,
                  e.data.success
                    ? (puter.setAuthToken(e.data.token), t(e.data))
                    : s(e.data),
                  window.removeEventListener("message", c))
              }
            ...
            return (
              (t =
                "object" == typeof e[0] && null !== e[0]
                  ...
                  : { success: e[0], error: e[1] }),
              new Promise((e, s) => {
                const n = O("/whoami", puter.APIOrigin, puter.authToken, "get")
                D(n, t.success, t.error, e, s), n.send()
              })
            )
          }
          signOut = () => {
      ...
      class X {
        ...
        _init() {
          ...
          e || (e = ""), (e = e.split(";"))
          for (const t of e) "" !== t && this.context.puter.logger.on(t)
        ...
        static response_handlers = {
          "application/x-ndjson": async (e) =>
            (async function* (e) {
              const t = e.getReader()
              let s, n
              for (; !n && (({ value: s, done: n } = await t.read()), !n); ) {
        ...
        async call({ driver: e, method_name: t, parameters: s }) {
          try {
            const n = await fetch(`${this.context.APIOrigin}/drivers/call`, {
              ...
              r = n.headers.get("content-type").split(";")[0].trim(),
              i = this.response_handlers[r]
            if (!i) {
              const i = `unrecognized content type: ${r}`
              throw (
                (console.error(i),
            ...
            throw (
              (globalThis.puter?.apiCallLogger?.isEnabled() &&
                globalThis.puter.apiCallLogger.logRequest({
                  ...
                  error: { message: n.message || n.toString(), stack: n.stack },
                }),
              n)
            )
          }
      ...
      const K = class {
          ...
          async get(e, t) {
            ...
            return this.drivers_[s]
              ? this.drivers_[s]
              : (this.drivers_[s] = new G({
                  call_backend: new V({ context: this.context }),
                  iface_name: e,
                  service_name: t,
                }))
          }
          async call(...e) {
            ...
            4 === e.length
              ...
              : 3 === e.length
              ? ([t, n, r] = e)
              : 2 === e.length && (([t, r] = e), (n = t))
            const i = await this.get(t, s)
            return await i.call(n, r)
          }
        },
      ...
      const Q = { type: "error", data: "parser error" },
        Z =
          "function" == typeof Blob ||
          ("undefined" != typeof Blob &&
            "[object BlobConstructor]" ===
              Object.prototype.toString.call(Blob)),
        J = "function" == typeof ArrayBuffer,
        $ = (e) =>
          "function" == typeof ArrayBuffer.isView
            ? ArrayBuffer.isView(e)
            : e && e.buffer instanceof ArrayBuffer,
        ee = ({ type: e, data: t }, s, n) =>
          Z && t instanceof Blob
            ? s
              ? n(t)
              : te(t, n)
      ...
      let ne
      const re = "undefined" == typeof Uint8Array ? [] : new Uint8Array(256)
      for (let e = 0; e < 64; e++)
        re[
      ...
      const ie = "function" == typeof ArrayBuffer,
        oe = (e, t) => {
          if ("string" != typeof e) return { type: "message", data: ce(e, t) }
          const s = e.charAt(0)
          return "b" === s
            ? { type: "message", data: ae(e.substring(1), t) }
            : Y[s]
            ? e.length > 1
              ? { type: Y[s], data: e.substring(1) }
              : { type: Y[s] }
            : Q
        },
        ae = (e, t) => {
          if (ie) {
            const s = ((e) => {
              ...
              for (t = 0; t < a; t += 4)
                (s = re[e.charCodeAt(t)]),
                  (n = re[e.charCodeAt(t + 1)]),
                  (r = re[e.charCodeAt(t + 2)]),
                  (i = re[e.charCodeAt(t + 3)]),
                  (h[c++] = (s << 2) | (n >> 4)),
                  (h[c++] = ((15 & n) << 4) | (r >> 2)),
                  (h[c++] = ((3 & r) << 6) | (63 & i))
              return l
      ...
      function he() {
        return new TransformStream({
          transform(e, t) {
            !(function (e, t) {
              Z && e.data instanceof Blob
                ? e.data.arrayBuffer().then(se).then(t)
                : J && (e.data instanceof ArrayBuffer || $(e.data))
                ? t(se(e.data))
                : ee(e, !1, (e) => {
                    ne || (ne = new TextEncoder()), t(ne.encode(e))
                  })
            })(e, (s) => {
              const n = s.length
              let r
      ...
      const ye = fe.setTimeout,
        be = fe.clearTimeout
      function we(e, t) {
        t.useNativeTimers
          ? ((e.setTimeoutFn = ye.bind(fe)), (e.clearTimeoutFn = be.bind(fe)))
      ...
      function Se() {
        const e = Ee(+new Date())
        return e !== Te ? ((xe = 0), (Te = e)) : e + "." + Ee(xe++)
      }
      for (; Ie < 64; Ie++) Ae[ke[Ie]] = Ie
      let Pe = !1
      try {
        Pe =
      ...
      function Ce(e) {
        ...
        if (!t)
          try {
            return new fe[["Active"].concat("Object").join("X")](
              "Microsoft.XMLHTTP"
            )
          } catch (e) {}
      }
      function De() {}
      const Re = null != new Ce({ xdomain: !1 }).responseType
      class Le extends ge {
        constructor(e, t) {
          super(),
            we(this, t),
        ...
        create() {
          ...
          "undefined" != typeof document &&
            ((this.index = Le.requestsCount++),
            (Le.requests[this.index] = this))
        }
        onError(e) {
        ...
        cleanup(e) {
          if (void 0 !== this.xhr && null !== this.xhr) {
            ...
            "undefined" != typeof document && delete Le.requests[this.index],
              (this.xhr = null)
          }
        }
        onLoad() {
      ...
      function Me() {
        for (let e in Le.requests)
          Le.requests.hasOwnProperty(e) && Le.requests[e].abort()
      }
      ;(Le.requestsCount = 0),
        (Le.requests = {}),
        "undefined" != typeof document &&
          ("function" == typeof attachEvent
            ...
            : "function" == typeof addEventListener &&
              addEventListener(
                "onpagehide" in fe ? "pagehide" : "unload",
                Me,
                !1
              ))
      const Ue =
          "function" == typeof Promise && "function" == typeof Promise.resolve
            ...
            : (e, t) => t(e, 0),
        qe = fe.WebSocket || fe.MozWebSocket,
        Be =
        ...
        Ne = {
          websocket: class extends _e {
            ...
            doOpen() {
              ...
              try {
                this.ws = Be ? new qe(e, t, s) : t ? new qe(e, t) : new qe(e)
              } catch (e) {
                          ...
                          transform(o, a) {
                            for (s.push(o); ; ) {
                              if (0 === n) {
                                ...
                                if (de(s) < r) break
                                const e = pe(s, r)
                                a.enqueue(oe(i ? e : ue.decode(e), t)), (n = 0)
                              }
                              if (0 === r || r > e) {
                                a.enqueue(Q)
                                break
        ...
        constructor(e, t = {}) {
          super(),
            ...
            e
              ...
              : t.host && (t.hostname = ze(t.host).host),
            we(this, t),
            (this.secure =
              null != t.secure
                ? t.secure
                ...
                if (!s)
                  if ("pong" === e.type && "probe" === e.data) {
                    if (
                      ...
                      return
                    ;(We.priorWebsocketSuccess = "websocket" === t.name),
      ...
      We.protocol = 4
      const Xe = "function" == typeof ArrayBuffer,
        Ve = Object.prototype.toString,
        Ge =
          "function" == typeof Blob ||
          ("undefined" != typeof Blob &&
            "[object BlobConstructor]" === Ve.call(Blob)),
        Ke =
          "function" == typeof File ||
          ("undefined" != typeof File &&
            "[object FileConstructor]" === Ve.call(File))
      function He(e) {
        return (
          (Xe &&
            (e instanceof ArrayBuffer ||
      ...
      function Ye(e, t) {
        ...
        if (Array.isArray(e)) {
          for (let t = 0, s = e.length; t < s; t++) if (Ye(e[t])) return !0
          return !1
        }
        if (He(e)) return !0
      ...
      function Ze(e, t) {
        ...
        if (Array.isArray(e)) {
          ...
          for (let n = 0; n < e.length; n++) s[n] = Ze(e[n], t)
          return s
        }
        if ("object" == typeof e && !(e instanceof Date)) {
          const s = {}
          for (const n in e)
            Object.prototype.hasOwnProperty.call(e, n) && (s[n] = Ze(e[n], t))
          return s
        }
        return e
      }
      function Je(e, t) {
        return (e.data = $e(e.data, t)), delete e.attachments, e
      }
      function $e(e, t) {
        if (!e) return e
        ...
        if (Array.isArray(e))
          for (let s = 0; s < e.length; s++) e[s] = $e(e[s], t)
        else if ("object" == typeof e)
          for (const s in e)
            Object.prototype.hasOwnProperty.call(e, s) && (e[s] = $e(e[s], t))
        return e
      }
      const et = [
        "connect",
      ...
      class nt extends ge {
        ...
        add(e) {
          ...
          if ("string" == typeof e) {
            ...
            const s = t.type === tt.BINARY_EVENT
            s || t.type === tt.BINARY_ACK
              ? ((t.type = s ? tt.EVENT : tt.ACK),
                (this.reconstructor = new rt(t)),
                0 === t.attachments && super.emitReserved("decoded", t))
              : super.emitReserved("decoded", t)
          } else {
            if (!He(e) && !e.base64) throw new Error("Unknown type: " + e)
            if (!this.reconstructor)
              throw new Error(
        ...
        decodeString(e) {
          ...
          if (s.type === tt.BINARY_EVENT || s.type === tt.BINARY_ACK) {
            const n = t + 1
          ...
          switch (e) {
            ...
            case tt.BINARY_EVENT:
              return (
                Array.isArray(t) &&
                ("number" == typeof t[0] ||
                  ("string" == typeof t[0] && -1 === et.indexOf(t[0])))
              )
            case tt.ACK:
            case tt.BINARY_ACK:
      ...
      class rt {
        ...
        takeBinaryData(e) {
          if (
            ...
            const e = Je(this.reconPack, this.buffers)
      ...
      var it = Object.freeze({
        ...
        Encoder: class {
          ...
          encode(e) {
            return (e.type !== tt.EVENT && e.type !== tt.ACK) || !Ye(e)
              ? [this.encodeAsString(e)]
              : this.encodeAsBinary({
                  type: e.type === tt.EVENT ? tt.BINARY_EVENT : tt.BINARY_ACK,
                  nsp: e.nsp,
                  data: e.data,
                  id: e.id,
                })
          ...
          encodeAsString(e) {
            let t = "" + e.type
            return (
              (e.type !== tt.BINARY_EVENT && e.type !== tt.BINARY_ACK) ||
                (t += e.attachments + "-"),
              e.nsp && "/" !== e.nsp && (t += e.nsp + ","),
              null != e.id && (t += e.id),
      ...
      class ct extends ge {
        ...
        emit(e, ...t) {
          ...
          const s = { type: tt.EVENT, data: t, options: {} }
          if (
        ...
        emitWithAck(e, ...t) {
          ...
          return new Promise((n, r) => {
            t.push((e, t) => (s ? (e ? r(e) : n(t)) : n(e))), this.emit(e, ...t)
          })
        }
        _addToQueue(e) {
          let t
        ...
        ack(e) {
          ...
          let s = !1
          return function (...n) {
            s || ((s = !0), t.packet({ type: tt.ACK, id: e, data: n }))
          }
        }
        onack(e) {
        ...
        socket(e, t) {
          ...
          return (
            s
              ...
              : ((s = new ct(this, e, t)), (this.nsps[e] = s)),
            s
          )
        }
        _destroy(e) {
      ...
      function dt(e, t) {
        ...
        const s = (function (e, t = "", s) {
          ...
          r = s.id,
          i = s.path,
          o = ut[r] && i in ut[r].nsps
        let a
        return (
          t.forceNew || t["force new connection"] || !1 === t.multiplex || o
            ? (a = new ht(n, t))
            : (ut[r] || (ut[r] = new ht(n, t)), (a = ut[r])),
          s.query && !t.query && (t.query = s.queryKey),
          a.socket(s.path, t)
        )
      }
      Object.assign(dt, { Manager: ht, Socket: ct, io: dt, connect: dt })
      const pt = (e) => (
          "gui" === puter.env ||
            (e || (e = "."),
        ...
        gt = function (...e) {
          ...
          return (
            ...
            new Promise(async (e, s) => {
              ...
              ;(t.source = pt(t.source)), (t.destination = pt(t.destination))
              const n = O("/copy", this.APIOrigin, this.authToken)
              D(n, t.success, t.error, e, s),
                n.send(
                  JSON.stringify({
        ...
        ft = function (...e) {
          ...
          return (
            ...
            new Promise(async (e, s) => {
              ...
              const n = O("/mkdir", this.APIOrigin, this.authToken)
              D(n, t.success, t.error, e, s),
                (t.path = pt(t.path)),
                n.send(
                  JSON.stringify({
            ...
            new Promise(async (e, s) => {
              ...
              const a = new Promise(async (e, s) => {
                ...
                D(
                  ...
                  t.error,
                  async (t) => {
                    JSON.stringify(t).length <= 20971520 &&
                      puter._cache.set(n, t),
                      e(t)
                  },
                  s
                )
                ...
                void 0 !== t.uid
                  ? (i.uid = t.uid)
                  : void 0 !== t.path && (i.path = pt(t.path)),
              ...
              mt.set(r, { promise: a, timestamp: o })
              try {
                const t = await a
                mt.delete(r), e(t)
              } catch (e) {
        ...
        bt = function (...e) {
          ...
          return (
            ...
            new Promise(async (e, s) => {
              ...
              if (
                ((t.source = pt(t.source)),
                (t.destination = pt(t.destination)),
                !t.new_name)
              )
                try {
                  if (!(await yt.bind(this)(t.destination)).is_dir)
                    throw "is not directory"
                } catch (e) {
                  ;(t.new_name = c.basename(t.destination)),
                    (t.destination = c.dirname(t.destination))
                }
              const n = O("/move", this.APIOrigin, this.authToken)
              D(n, t.success, t.error, e, s),
                n.send(
                  JSON.stringify({
                    source: t.source,
              ...
              const n = O(
                "/read?" +
                  new URLSearchParams({
                    ...
                    ...(t.byte_count ? { byte_count: t.byte_count } : {}),
                  }).toString(),
                this.APIOrigin,
                this.authToken,
                "get",
        ...
        _t = async function (...e) {
          ...
          return (
            (t =
              "object" == typeof e[0] && null !== e[0]
                ? e[0]
                : { path: e[0], success: e[1], error: e[2] }),
            new Promise(async (e, s) => {
              if (
                (t.consistency || (t.consistency = "strong"), !t.path && !t.uid)
              )
                throw new Error({
                  code: "NO_PATH_OR_UID",
              ...
              const a = new Promise(async (e, s) => {
                ...
                D(
                  ...
                  t.error,
                  async (t) => {
                    JSON.stringify(t).length <= 104857600 &&
                      puter._cache.set(n, t)
                ...
                t.uid ? (i.uid = t.uid) : t.path && (i.path = pt(t.path)),
                  r.send(JSON.stringify(i))
              })
              vt.set(r, { promise: a, timestamp: o })
              try {
                const t = await a
                vt.delete(r), e(t)
              } catch (e) {
        ...
        kt = function (...e) {
          ...
          return (
            ...
            new Promise(async (e, s) => {
              ...
              const n = O("/rename", this.APIOrigin, this.authToken)
              D(n, t.success, t.error, e, s)
              let r = {
                original_client_socket_id:
              ...
              void 0 !== t.uid
                ? (r.uid = t.uid)
                : void 0 !== t.path && (r.path = pt(t.path)),
        ...
        At = function (...e) {
          ...
          return (
            ...
            new Promise(async (e, s) => {
              ...
              let n = t.items
              Array.isArray(n) || (n = [n])
              const r = O("/sign", this.APIOrigin, this.authToken)
              r.addEventListener("load", async function (r) {
                const i = await S(this)
                if (200 !== this.status)
                  return (
                    t.error && "function" == typeof t.error && t.error(i), s(i)
                  )
                {
                  let s,
                    r = i,
                    o = r.token
                  if (1 == n.length) s = { ...r.signatures[0] }
                  else {
                    let e = []
                    for (let t = 0; t < r.signatures.length; t++)
                      e.push({ ...r.signatures[t] })
                    s = e
                  }
                  return (
                    t.success &&
                      "function" == typeof t.success &&
                      t.success({ token: o, items: s }),
                    e({ token: o, items: s })
                  )
                }
              }),
                ...
                r.addEventListener("error", function (e) {
                  return C(t.error, s, this)
                }),
                r.send(JSON.stringify({ app_uid: t.app_uid, items: n }))
            })
          )
        },
        Tt = function (...e) {
          ...
          return (
            ...
            new Promise(async (e, s) => {
              ...
              const n = O("/df", this.APIOrigin, this.authToken)
              D(n, t.success, t.error, e, s), n.send()
            })
          )
        },
        xt = async function (e, t) {
          ...
          const s = c.basename(t),
            n = { op: "symlink", path: c.dirname(t), name: s, target: e },
            r = new FormData()
          r.append("operation", JSON.stringify(n))
          try {
        ...
        It = async function (e, t, s = {}) {
          return new Promise(async (n, r) => {
            ...
            const l = (e) => (
              s.error && "function" == typeof s.error && s.error(e), r(e)
            )
            ...
            if (Array.isArray(e) && e.length > 0)
              for (let t = 0; t < e.length; t++)
                (e[t] instanceof i || e[t] instanceof a) && (m = !0)
            if (
              e instanceof a ||
              e instanceof i ||
              e[0] instanceof i ||
              s.parsedDataTransferItems
            )
              (d = s.parsedDataTransferItems
                ? e
                : await puter.ui.getEntriesFromDataTransferItems(e)),
                d.sort((e, t) =>
              ...
              ;(d = Array.isArray(e)
                ...
                ? Array.from(e)
                : [e]),
                d.sort((e, t) => e.size - t.size)
              for (let e = 0; e < d.length; e++)
                (d[e].filepath = d[e].name), (d[e].fullPath = d[e].name)
            } else if (e instanceof Blob) {
              d = [new File([e], s.name, { type: "application/octet-stream" })]
              for (let e = 0; e < d.length; e++)
                (d[e].filepath = d[e].name), (d[e].fullPath = d[e].name)
            } else {
              if ("string" != typeof e)
              ...
              d = [new File([e], "default.txt", { type: "text/plain" })]
              for (let e = 0; e < d.length; e++)
                (d[e].filepath = d[e].name), (d[e].fullPath = d[e].name)
            }
            let y,
              ...
              if (d[e]) {
                if (d[e].isDirectory)
                  b.push({
                    path: c.join(
                      t,
                      d[e].finalPath ? d[e].finalPath : d[e].fullPath
                    ),
                  })
                else {
                  let n = d[e].finalPath ? d[e].finalPath : d[e].fullPath,
                    [r, i] = [
                  ...
                  if (
                    ("" != i && v.push(d[e]),
                    s.createFileParent && n.includes("/"))
                  ) {
                    let e
                    r.split("/").forEach((s) => {
                      e = e ? e + "/" + s : s
                      let n = c.join(t, e)
                      w[n] || ((w[n] = !0), b.push({ path: n }))
                    })
                  }
                }
                void 0 !== d[e].size && (f += d[e].size)
              }
            ...
            for (let e = 0; e < b.length; e++) {
              for (let s = 0; s < v.length; s++)
                !v[s].puter_path_param &&
                  ...
                  (v[s].puter_path_param =
                    `$dir_${e}/` + c.basename(v[s].filepath))
            ...
            for (let e = 0; e < b.length; e++) {
              let t = c.dirname(b[e].puter_path_param || b[e].path),
                n = b[e].puter_path_param || b[e].path
              "/" !== t && (n = n.replace(t, "")),
                k.push({
                  op: "mkdir",
                  parent: t,
            ...
            k.reverse(),
              _.append("operation_id", u),
              _.append("socket_id", this.socket.id),
              _.append("original_client_socket_id", this.socket.id)
            for (let e = 0; e < k.length; e++)
              _.append("operation", JSON.stringify(k[e]))
            if (!s.shortcutTo)
              ...
              _.append(
                ...
                JSON.stringify({
                  ...
                  create_missing_ancestors:
                    s.createMissingAncestors || s.createMissingParents,
                  operation_id: u,
                  path:
                    (v[e].puter_path_param &&
                      c.dirname(v[e].puter_path_param ?? "")) ||
            ...
            if (!s.shortcutTo)
              for (let e = 0; e < v.length; e++) _.append("file", v[e] ?? "")
            const A = (e) => {
              e.operation_id === u && (g += e.loaded_diff)
            }
            this.socket.on("upload.progress", A)
            let T = null
            h.open("post", this.APIOrigin + "/batch", !0),
              ...
              h.upload.addEventListener("progress", function (e) {
                let t
                null === T ? ((t = e.loaded), (T = 0)) : (t = e.loaded - T),
                  (T += t),
                  (p += t)
                let n = (((g + p) / f) * 100).toFixed(2)
                ;(n = n > 100 ? 100 : n),
                  s.progress &&
            ...
            ;(h.onabort = () => {
              clearInterval(x),
                this.socket.off("upload.progress", A),
        ...
        Et = async function (e, t, s = {}) {
          ...
          if (
            ("string" == typeof t
              ? (t = new File([t ?? ""], n ?? "Untitled.txt", {
                  type: "text/plain",
                }))
              : t instanceof Blob
              ? (t = new File([t ?? ""], n ?? "Untitled", { type: t.type }))
              : (t instanceof ArrayBuffer || ArrayBuffer.isView(t)) &&
                (t = new File([t], n ?? "Untitled", {
          ...
          constructor(e) {
            ...
            Object.defineProperty(this, "_internalProperties", {
              ...
              (t.signature =
                e.signature ??
                (() =>
                  new URL(this.writeURL ?? this.readURL).searchParams.get(
                    "signature"
                  ))()),
              (t.expires =
                e.expires ??
        ...
        Pt = async function (...e) {
          ...
          return (
            ...
            new Promise(async (e, n) => {
              ...
              const r = O("/delete", this.APIOrigin, this.authToken)
              D(r, t.success, t.error, e, n),
                (s = s.map((e) => pt(e))),
                r.send(
                  JSON.stringify({
                    paths: s,
        ...
        Ot = async function (e, t = "24h") {
          return new Promise(async (s, n) => {
            ...
            try {
              const { uid: r, is_dir: i } = await yt.call(this, e)
              ...
              D(
                ...
                ({ token: e }) => {
                  s(
                    `${this.APIOrigin}/token-read?uid=${encodeURIComponent(
                      r
        ...
        Ct = "last_valid_ts"
      class Dt extends e.AdvancedBase {
        space = Tt
        mkdir = ft
        copy = gt
        rename = kt
        ...
        initializeSocket() {
          this.socket && this.socket.disconnect(),
            (this.socket = dt(this.APIOrigin, {
              auth: { auth_token: this.authToken },
              autoUnref: "nodejs" === this.context.env,
            })),
        ...
        setAuthToken(e) {
          ;(this.authToken = e),
            "gui" === this.context.env &&
              (this.checkCacheAndPurge(), this.startCacheUpdateTimer()),
            this.initializeSocket()
        }
        setAPIOrigin(e) {
        ...
        invalidateCache() {
          localStorage.setItem(Ct, "0"), puter._cache.flushall()
        }
        ...
        async checkCacheAndPurge() {
          try {
            ;(await this.getCacheTimestamp()) -
              (parseInt(localStorage.getItem(Ct)) || 0) >
              2e3 &&
      ...
      const Rt = class {
        ...
        list = async (...e) =>
          (await M([], "puter-subdomains", void 0, "select")(...e)).filter(
        ...
        create = async (...e) => {
          ...
          return (
            ...
            await M(["object"], "puter-subdomains", void 0, "create").call(
              this,
              t
            )
          )
        ...
        update = async (...e) => {
          ...
          return (
            ...
            await M(["object"], "puter-subdomains", void 0, "update").call(
              this,
              t
            )
          )
          ...
          return (
            Array.isArray(e) &&
              ...
              (e[0].match(/^[a-z0-9]+\.puter\.(site|com)$/) &&
                (e[0] = e[0].split(".")[0]),
              (t = { id: { subdomain: e[0] } })),
            M(["uid"], "puter-subdomains", void 0, "read").call(this, t)
          )
        }
        delete = async (...e) => {
          let t = {}
          return (
            Array.isArray(e) &&
              ...
              (e[0].match(/^[a-z0-9]+\.puter\.(site|com)$/) &&
                (e[0] = e[0].split(".")[0]),
              (t = { id: { subdomain: e[0] } })),
            M(["uid"], "puter-subdomains", void 0, "delete").call(this, t)
          )
        }
      }
      var Lt = s(717)
      ...
      const qt = class {
        ...
        constructor(e) {
          ;(this.authToken = e.authToken),
            (this.APIOrigin = e.APIOrigin),
            (this.appID = e.appID),
            (this.gui_cached = new Lt.TeePromise()),
            (this.gui_cache_init = new Lt.TeePromise()),
            (async () => {
              ...
              const s = {}
              for (let e = 0; e < Mt.length; e++) s[Mt[e]] = t.result[e]
        ...
        set = M(["key", "value", "expireAt"], "puter-kvstore", void 0, "set", {
          preprocess: (e) => {
        ...
        get_ = M(["key"], "puter-kvstore", void 0, "get", {
          preprocess: (e) => {
            if (e.key.length > this.MAX_KEY_SIZE)
              throw {
                message: `Key size cannot be larger than ${this.MAX_KEY_SIZE}`,
        ...
        incr = async (...e) => {
          ...
          return M(["key"], "puter-kvstore", void 0, "incr").call(this, t)
        }
        decr = async (...e) => {
          let t = {}
          if (!e || 0 === e.length)
          ...
          return M(["key"], "puter-kvstore", void 0, "decr").call(this, t)
        }
        expire = async (e, t) => {
          let s = {}
          ...
          return M(["key", "ttl"], "puter-kvstore", void 0, "expire").call(
            this,
            s
          )
        }
        expireAt = async (e, t) => {
          let s = {}
          if (
            ((s.key = e), (s.timestamp = t), s.key.length > this.MAX_KEY_SIZE)
          )
            throw {
              message: `Key size cannot be larger than ${this.MAX_KEY_SIZE}`,
              code: "key_too_large",
        ...
        del = M(["key"], "puter-kvstore", void 0, "del", {
          preprocess: (e) => {
            if (e.key.length > this.MAX_KEY_SIZE)
              throw {
                message: `Key size cannot be larger than ${this.MAX_KEY_SIZE}`,
          ...
          return (
            ...
            ((e && 1 === e.length && "string" == typeof e[0]) ||
              (e &&
                ...
                !0 === e[1])) &&
              (t = e[0]),
            M([], "puter-kvstore", void 0, "list", {
              transform: (e) =>
                t
                  ? n
                    ? e.filter((e) => Ut(t, e.key))
                    : e.filter((e) => Ut(t, e))
                  : e,
            }).call(this, s)
          )
        }
        flush = M([], "puter-kvstore", void 0, "flush")
        clear = this.flush
      }
      class Bt {
        #s
        ...
        on(e, t) {
          if (this.#s.includes(e)) return this.#n[e].push(t), this
          console.error(`Event name '${e}' not supported`)
        }
        off(e, t) {
      ...
      function zt(e) {
        ...
        switch (e.packetType) {
          case 1:
            ;(e.hostEncoded = jt.encode(e.hostname)),
          ...
          case 5:
            ;(t += 2),
              e.password && (t += 6),
              e.puterAuth &&
                ((e.passwordEncoded = jt.encode(e.puterAuth)),
        ...
        switch (
          ...
          case 5:
            n.setUint8(5, 2),
              n.setUint8(6, 0),
              e.password &&
                (n.setUint8(7, 2), n.setUint32(8, 1, !0), n.setUint8(12, 0)),
              e.puterAuth &&
                (n.setUint8(7, 2),
      ...
      class Wt {
              ...
              (this._ws.onmessage = (e) => {
                const n = (function (e) {
                  ...
                  switch (s) {
                    ...
                    case 5:
                      const r = {}
                      ;(r.version_major = t.getUint8(5)),
                        (r.version_minor = t.getUint8(6))
                      let i = 7
                      for (; i < e.length; ) {
                      ...
                      return { packetType: s, streamID: n, infoObj: r }
                  }
                ...
                switch (n.packetType) {
                  case 2:
                    this.streamMap
                      .get(n.streamID)
                      .dataCallBack(n.payload.slice(0))
                    break
                  case 3:
                    if (0 === n.streamID)
                      return (
                        (this._bufferMax = n.remainingBuffer),
                        (this._ws.onclose = () => {
                          setTimeout(s(), 1e3)
                        }),
                        void (this.onReady && this.onReady())
                      )
                    ;(this.streamMap.get(n.streamID).buffer =
                      n.remainingBuffer),
                      this._continue()
                    break
                  case 4:
                    0 !== n.streamID &&
                      this.streamMap.get(n.streamID).closeCallBack(n.reason)
                    break
                  case 5:
                    t &&
                      this._ws.send(
                        zt({ packetType: 5, streamID: 0, puterAuth: t })
                      )
                }
              })
          }
        ...
        write(e, t) {
          ...
          s.buffer > 0
            ? (s.buffer--,
              this._ws.send(zt({ packetType: 2, streamID: e, payload: t })))
            : s.queue.push(t)
        }
        close(e) {
          this._ws.send(zt({ packetType: 4, streamID: e, reason: 2 }))
        }
      }
      const Xt = new TextEncoder()
      let Vt,
        Gt = { server: "wss://puter.cafe/", handler: void 0 }
      class Kt extends Bt {
        _events = new Map()
        _streamID
        constructor(e, t) {
          super([
            ...
            (async () => {
              if ((!puter.authToken && puter.env, !Gt.handler)) {
                ...
                ;(Gt.handler = new Wt(t, e)),
                  await new Promise((e, t) => {
                    Gt.handler.onReady = e
                  })
              }
              const s = {
                dataCallBack: (e) => {
                ...
                closeCallBack: (e) => {
                  if (2 !== e)
                    return (
                      this.emit("error", new Error(Ft[e])),
                      void this.emit("close", !0)
                    )
                  this.emit("close", !1)
                },
              }
              ;(this._streamID = Gt.handler.register(e, t, s)),
                setTimeout(() => {
        ...
        write(e, t) {
          if (e.buffer) Gt.handler.write(this._streamID, e), t && t()
          else if (e.resize)
            ...
            Gt.handler.write(this._streamID, Xt.encode(e)), t && t()
          }
        }
        close() {
          Gt.handler.close(this._streamID)
        }
      }
      class Ht extends Kt {
        constructor(...e) {
          super(...e),
            super.on("open", async () => {
              Vt ||
                ...
                (Vt = await import("https://puter-net.b-cdn.net/rustls.js")),
                await Vt.default("https://puter-net.b-cdn.net/rustls.wasm"))
              let t = !1
              ...
              let r, i
              try {
                const t = await Vt.connect_tls(s, n, e[0])
                ;(r = t.read), (i = t.write)
              } catch (e) {
      ...
      function Yt(...e) {
        return new Promise(async (t, s) => {
          try {
            ...
            if ("http:" === r.protocol)
              i = new puter.net.Socket(r.hostname, r.port || 80)
            else {
              if ("https:" !== r.protocol) {
                const e = `Failed to fetch. URL scheme "${r.protocol}" is not supported.`
                return (
                  globalThis.puter?.apiCallLogger?.isEnabled() &&
                    globalThis.puter.apiCallLogger.logRequest({
                      service: "network",
                      operation: "pFetch",
                      params: { url: n.url, method: n.method },
                      error: { message: e },
                    }),
                  void s(e)
                )
              }
              i = new puter.net.tls.TLSSocket(r.hostname, r.port || 443)
            }
            o.get("user-agent") || o.set("user-agent", navigator.userAgent)
            let a,
              c = `${n.method} ${r.pathname}${r.search} HTTP/1.1\r\nHost: ${r.host}\r\nConnection: close\r\n`
            for (const [e, t] of o) c += `${e}: ${t}\r\n`
            if (n.body) {
              if (
                ((a = new Uint8Array(await n.arrayBuffer())),
                o.has("content-length"))
              ) {
                  ...
                  for (s.set(b, 0), s.set(t, b.length), b = s; ; )
                    if (y > 0) {
                      ...
                      if (
                        ...
                        return (p = !0), void e.close()
                    }
                }
                i.on("data", (s) => {
                  if (
                    (-1 === u || m || (e.enqueue(s), (f += s.length)),
                    -1 === u && (d.push(s), (h += l.decode(s, { stream: !0 }))),
                    m && r(s),
                    -1 !== h.indexOf("\r\n\r\n"))
                  ) {
                    ;(u = h.indexOf("\r\n\r\n")), (h = h.slice(0, u))
                    const s = (function (e) {
                      ...
                      return (
                        new Headers(i),
                        { headers: new Headers(i), statusText: r, status: n }
                      )
                    })(h)
                    ...
                    m ? r(i) : ((f += i.length), e.enqueue(i))
                  }
                  ;-1 === g || f !== g || m || p || ((p = !0), e.close())
                }),
                  i.on("close", () => {
                    p || ((p = !0), e.close())
                  }),
                  i.on("error", (e) => {
                    globalThis.puter?.apiCallLogger?.isEnabled() &&
                      globalThis.puter.apiCallLogger.logRequest({
                        ...
                        error: {
                          message:
                            "Socket errored with the following reason: " + e,
                        },
                      }),
      ...
      const Qt = class {
        ...
        user = function (...e) {
          ...
          return (
            ...
            new Promise((e, n) => {
              const r = O("/whoami" + s, this.APIOrigin, this.authToken, "get")
              D(r, t.success, t.error, e, n), r.send()
            })
          )
        }
        version = function (...e) {
          ...
          return (
            (t =
              "object" == typeof e[0] && null !== e[0]
                ...
                : { success: e[0], error: e[1] }),
            new Promise((e, s) => {
              const n = O("/version", this.APIOrigin, this.authToken, "get")
              D(n, t.success, t.error, e, s), n.send()
            })
          )
        }
      ...
      class Zt {
        constructor(e) {
          ;(this.authToken = e.authToken), (this.APIOrigin = e.APIOrigin)
        }
        setAuthToken(e) {
          this.authToken = e
        }
      ...
      class $t {
        ...
        async list(e, t, s) {
          return await this.req_(
            "POST",
            "/threads/list/" + encodeURIComponent(e) + "/" + t,
            s ?? {}
          )
        }
        async subscribe(e, t) {
          puter.fs.socket.emit("thread.sub-request", { uid: e })
      ...
      class es extends (globalThis.HTMLElement || Object) {
      ...
      es.__proto__ === globalThis.HTMLElement &&
        customElements.define("puter-dialog", es)
      const ts = es,
        ss = Symbol("FILE_SAVE_CANCELLED"),
        ns = Symbol("FILE_OPEN_CANCELLED")
      class rs extends Bt {
        #r = "*"
        #i
        #o
        static from(e, t) {
          const s = new rs(t, { target: e.appInstanceID, usesSDK: e.usesSDK })
        ...
        constructor(e, { target: t, usesSDK: s }) {
          super(["message", "close"]),
            ...
            (this.#i = !0),
            (this.#o = s),
            (this.log = e.puter.logger.fields({ category: "ipc" })),
            this.log
              .fields({
      ...
      const is = class extends Bt {
          ...
          async #y({ callback: e, method: t, parameters: s }) {
            let n, r
            await new Promise((e) => {
              n = new Promise((t) => {
                ;(r = t), e()
            ...
            const i = this.util.rpc.registerCallback(r)
            this.messageTarget?.postMessage(
              {
                $: "puter-ipc",
                v: 2,
              ...
              window.addEventListener("message", async (e) => {
                if (e.data) {
                  ...
                  if (e.data.msg && "focus" === e.data.msg) window.focus()
                    ...
                    if (void 0 === this.#h)
                      ...
                      if (e.data.items.length > 0)
                        for (let s = 0; s < e.data.items.length; s++)
                          t.push(new St(e.data.items[s]))
                      this.#h(t)
                    }
                  else if ("getAppDataSucceeded" === e.data.msg) {
                    let t = new St(e.data.item)
                    e.data.original_msg_id &&
                      this.#c[e.data.original_msg_id] &&
                      this.#c[e.data.original_msg_id](t)
                  } else if ("instancesOpenSucceeded" === e.data.msg)
                    e.data.original_msg_id &&
                      this.#c[e.data.original_msg_id] &&
                      this.#c[e.data.original_msg_id](e.data.instancesOpen)
                    ...
                    e.data.original_msg_id &&
                      this.#c[e.data.original_msg_id] &&
                      this.#c[e.data.original_msg_id](null)
                  else if (
                    ...
                    if ("fileOpenPicked" === e.data.msg) {
                      if (1 === e.data.items.length)
                        this.#c[e.data.original_msg_id](new St(e.data.items[0]))
                      ...
                      "colorPicked" === e.data.msg
                        ? this.#c[e.data.original_msg_id](e.data.color)
                        : "fontPicked" === e.data.msg
                        ? this.#c[e.data.original_msg_id](e.data.font)
                        : "alertResponded" === e.data.msg ||
                          "promptResponded" === e.data.msg
                        ? this.#c[e.data.original_msg_id](e.data.response)
                        : "languageReceived" === e.data.msg
                        ? this.#c[e.data.original_msg_id](e.data.language)
                        : "fileSaved" === e.data.msg
                        ? this.#c[e.data.original_msg_id](
                            new St(e.data.saved_file)
                          )
                        : "fileSaveCancelled" === e.data.msg
                        ? this.#c[e.data.original_msg_id](ss)
                        : "fileOpenCancelled" === e.data.msg
                        ? this.#c[e.data.original_msg_id](ns)
                        : this.#c[e.data.original_msg_id](e.data)
                    delete this.#c[e.data.original_msg_id]
                  } else if (
                    ...
                    this.itemWatchCallbackFunctions[e.data.data.uid] &&
                      "function" ==
                        typeof this.itemWatchCallbackFunctions[
                          e.data.data.uid
                        ] &&
                      this.itemWatchCallbackFunctions[e.data.data.uid](
                        e.data.data
                    ...
                    this.emit(t, s), this.#d.set(t, s)
                  } else if ("connection" === e.data.msg) {
                    e.data.usesSDK = !0
                    const t = rs.from(e.data, this.context),
                      s = (t) => {
                        this.messageTarget?.postMessage(
                          {
                            $: "connection-resp",
                    ...
                    this.emit("connection", { conn: t, accept: s, reject: n })
                  }
                }
              }),
          ...
          requestEmailConfirmation() {
            return new Promise((e, t) => {
              this.#f("requestEmailConfirmation", e, {})
            })
          }
          alert(e, t, s, n) {
            return new Promise((n) => {
              this.#f("ALERT", n, { message: e, buttons: t, options: s })
            })
          }
          openDevPaymentsAccount() {
            return new Promise((e) => {
              this.#f("openDevPaymentsAccount", e, {})
            })
          }
          instancesOpen(e) {
            return new Promise((e) => {
              this.#f("getInstancesOpen", e, {})
            })
          }
          socialShare(e, t, s, n) {
            return new Promise((n) => {
              this.#f("socialShare", n, { url: e, message: t, options: s })
            })
          }
          prompt(e, t, s, n) {
            return new Promise((n) => {
              this.#f("PROMPT", n, { message: e, placeholder: t, options: s })
            })
          }
          showDirectoryPicker(e, t) {
            return new Promise((t, s) => {
              if (!globalThis.open)
                return s("This API is not compatible in Web Workers.")
              const n = this.#t++
              if ("app" === this.env)
                this.messageTarget?.postMessage(
                  {
                ...
                window.open(
                  ...
                  o,
                  `toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=no, resizable=no, copyhistory=no, width=${t}, height=${s}, top=${i}, left=${r}`
                )
              }
              this.#c[n] = t
            })
          }
          showOpenFilePicker(t, s) {
            const n = new e.libs.promise.TeePromise(),
              r = new Promise((e, s) => {
                if (!globalThis.open)
                  return s("This API is not compatible in Web Workers.")
                const r = this.#t++
                if ("app" === this.env)
                  ...
                  let e = 700,
                    s = 400,
                    n = "Puter: Open File"
                  var i = screen.width / 2 - e / 2,
                    o = screen.height / 2 - s / 2
                  window.open(
                    `${
                      puter.defaultGUIOrigin
                    }/action/show-open-file-picker?embedded_in_popup=true&msg_id=${r}&appInstanceID=${
                      this.appInstanceID
                    }&env=${this.env}&options=${JSON.stringify(t ?? {})}`,
                    n,
                    `toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=no, resizable=no, copyhistory=no, width=${e}, height=${s}, top=${o}, left=${i}`
                  )
                }
                this.#c[r] = (t) => {
                  t !== ns ? (n.resolve(t), e(t)) : n.resolve(void 0)
                }
              })
            return (r.undefinedOnCancel = n), r
          }
          showFontPicker(e) {
          ...
          requestUpgrade() {
            return new Promise((e) => {
              this.#f("requestUpgrade", e, {})
            })
          }
          showSaveFilePicker(t, s, n) {
            const r = new e.libs.promise.TeePromise(),
              i = new Promise((e, i) => {
                if (!globalThis.open)
                  return i("This API is not compatible in Web Workers.")
                const o = this.#t++
                n ||
                  "[object URL]" !== Object.prototype.toString.call(t) ||
                  (n = "url")
                const a = "url" === n ? t.toString() : void 0,
                  c = ["move", "copy"].includes(n) ? t : void 0
                if ("app" === this.env)
                  this.messageTarget?.postMessage(
                    {
                  ...
                  let e = new Blob([t], { type: "application/octet-stream" }),
                    n = URL.createObjectURL(e),
                    r = 700,
                    i = 400,
                    c = "Puter: Save File"
                  var l = screen.width / 2 - r / 2,
                    h = screen.height / 2 - i / 2
                  window.open(
                    `${
                      puter.defaultGUIOrigin
                    }/action/show-save-file-picker?embedded_in_popup=true&msg_id=${o}&appInstanceID=${
                      this.appInstanceID
                    }&env=${this.env}&blobUrl=${encodeURIComponent(n)}`,
                    c,
                    `toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=no, resizable=no, copyhistory=no, width=${r}, height=${i}, top=${h}, left=${l}`
                  )
                }
                this.#c[o] = (t) => {
                  t !== ss ? (r.resolve(t), e(t)) : r.resolve(void 0)
                }
              })
            return (i.undefinedOnCancel = r), i
          }
          setWindowTitle(e, t, s) {
            return (
              ...
              new Promise((s) => {
                this.#f("setWindowTitle", s, { new_title: e, window_id: t })
              })
            )
          }
          setWindowWidth(e, t, s) {
            return (
              "function" == typeof t
                ...
                : "object" == typeof t && null !== t && (t = t.id),
              new Promise((s) => {
                this.#f("setWindowWidth", s, { width: e, window_id: t })
              })
            )
          }
          setWindowHeight(e, t, s) {
            return (
              "function" == typeof t
                ...
                : "object" == typeof t && null !== t && (t = t.id),
              new Promise((s) => {
                this.#f("setWindowHeight", s, { height: e, window_id: t })
              })
            )
          }
          setWindowSize(e, t, s, n) {
            return (
              "function" == typeof s
                ? (s = void 0)
                : "object" == typeof s && null !== s && (s = s.id),
              new Promise((n) => {
          ...
          setWindowPosition(e, t, s, n) {
            return (
              "function" == typeof s
                ? (s = void 0)
                : "object" == typeof s && null !== s && (s = s.id),
              new Promise((n) => {
                this.#f("setWindowPosition", n, { x: e, y: t, window_id: s })
              })
            )
          }
          setWindowY(e, t, s) {
            return (
              "function" == typeof t
                ...
                : "object" == typeof t && null !== t && (t = t.id),
              new Promise((s) => {
                this.#f("setWindowY", s, { y: e, window_id: t })
              })
            )
          }
          setWindowX(e, t, s) {
            return (
              "function" == typeof t
                ...
                : "object" == typeof t && null !== t && (t = t.id),
              new Promise((s) => {
                this.#f("setWindowX", s, { x: e, window_id: t })
              })
            )
          }
          showWindow() {
          ...
          requestPermission(e) {
            return new Promise((t) => {
              if ("app" === this.env)
                return new Promise((t) => {
                  this.#f("requestPermission", t, { options: e })
                })
              t(!1)
            })
          }
          disableMenuItem(e) {
            this.#m("disableMenuItem", { id: e })
          }
          enableMenuItem(e) {
            this.#m("enableMenuItem", { id: e })
          }
          setMenuItemIcon(e, t) {
            this.#m("setMenuItemIcon", { id: e, icon: t })
          }
          setMenuItemIconActive(e, t) {
            this.#m("setMenuItemIconActive", { id: e, icon: t })
          }
          setMenuItemChecked(e, t) {
            this.#m("setMenuItemChecked", { id: e, checked: t })
          }
          contextMenu(e) {
            this.#m("contextMenu", e)
          }
          ...
          launchApp = async function (e, t, s) {
            ...
            if (i) {
              ...
              for (let e = 0; e < i.length; e++)
                i[e] instanceof St &&
                  (i[e] = i[e]._internalProperties.file_signature)
            }
            o && o.includes("#(as)") && ([o, n] = o.split("#(as)")),
              o || (o = puter.appName)
            const a = await this.#y({
              method: "launchApp",
              callback: s,
              parameters: {
                app_name: o,
          ...
          on(e, t) {
            super.on(e, t),
              this.#s.includes(e) && this.#d.has(e) && t(this.#d.get(e))
          }
          #b = null
          #w = null
          showSpinner(e) {
          ...
          getLanguage() {
            return "gui" === this.env
              ...
              : new Promise((e) => {
                  this.#f("getLanguage", e, {})
                })
          }
        },
        os = "9a9c83a4-7897-43a0-93b9-53217b84fde6"
      class as {
        #_ = 1
        constructor() {
        ...
        attach_to_source(e) {
          e.addEventListener("message", (e) => {
            const { data: t } = e
            if (t && "object" == typeof t && t.$SCOPE === os) {
              const { id: e, args: s } = t,
      ...
      class ls {
        ...
        hydrate_value_(e) {
          if (e && "object" == typeof e && e.$SCOPE === os) {
            const { id: t } = e
            return (...e) => {
              this.target.postMessage({ $SCOPE: os, id: t, args: e }, "*")
            }
          }
      ...
      class us {
        constructor() {
          ;(this.callbackManager = new as()),
            this.callbackManager.attach_to_source(globalThis)
        }
        getDehydrator() {
          return new cs({ callbackManager: this.callbackManager })
        }
        getHydrator({ target: e }) {
          return new ls({ target: e })
        }
        registerCallback(e) {
          return this.callbackManager.register_callback(e)
        }
        send(e, t, ...s) {
          e.postMessage({ $SCOPE: os, id: t, args: s }, "*")
        }
      }
      class ds {
        constructor(e) {
        ...
        async create(e, t, s) {
          ...
          let n
          "string" == typeof s &&
            (n = (await puter.apps.list()).find((e) => e.name === s).uid),
            (e = e.toLocaleLowerCase())
          let r = await puter.kv.get("user-workers")
          r || (r = {}), (t = pt(t))
          const i = await M(
            ...
            "worker-service",
            "create"
          )(puter.authToken, t, e, n)
          if (!i.success)
            throw new Error(
              i?.errors ||
                "Driver failed to execute, do you have the necessary permissions?"
            )
          return (
            (r[e] = {
              filePath: t,
            ...
            await puter.kv.set("user-workers", r),
            i
          )
        }
        async exec(...e) {
          ...
          return (
            t.headers.get("puter-auth") ||
              t.headers.set("puter-auth", puter.authToken),
            fetch(t)
          )
        }
        async list() {
          ...
          return await M([], "workers", "worker-service", "getFilePaths")()
        }
        async get(e) {
          if (!puter.authToken && "web" === puter.env)
            try {
        ...
        async delete(e) {
          ...
          if (t.result) {
            ...
            return (
              t || (t = {}),
              delete t[e],
              await puter.kv.set("user-workers", t),
              !0
            )
          }
          throw (
          ...
          return (
            ...
            new Promise((e, t) => {
              ...
              ;(s.onopen = () => {
                ...
                (s.onerror = () => {
                  r || t("Failed to open logging connection")
                })
            })
          )
        }
      }
      const { TTopics: ps } = e.traits
      class gs extends e.concepts.Service {
        static TOPICS = ["update"]
        static PROPERTIES = {
          auth_token: {
            post_set(e) {
              this.as(ps).pub("update")
            },
          },
          api_origin: {
            post_set() {
        ...
        get_api_info() {
          ...
          return (
            [
              ...
              Object.defineProperty(t, s, { get: () => e[n], set: (t) => e })
            }),
            t
          )
        }
      }
      const fs = "TFilesystem"
      class ms extends e.AdvancedBase {
      ...
      class ys extends e.AdvancedBase {
        ...
        static IMPLEMENTS = {
          [fs]: {
            stat: async function (e) {
              ...
              D(s, void 0, void 0, t.resolve.bind(t), t.reject.bind(t))
              let n = {}
              return (
                void 0 !== e.uid
                  ? (n.uid = e.uid)
                  : void 0 !== e.path && (n.path = pt(e.path)),
                (n.return_subdomains = e.returnSubdomains),
                (n.return_permissions = e.returnPermissions),
                (n.return_versions = e.returnVersions),
                (n.return_size = e.returnSize),
                (n.auth_token = this.api_info.authToken),
            ...
            readdir: async function (e) {
              ...
              return (
                ...
                s.send(
                  JSON.stringify({
                    path: pt(e.path),
                    auth_token: this.api_info.authToken,
                  })
                ),
                await t
              )
      ...
      class bs extends e.AdvancedBase {
        static PROPERTIES = {
          assocs_path_: () => ({}),
          assocs_uuid_: () => ({}),
          entries: () => ({}),
        ...
        add_entry({ id: e } = {}) {
          const t = e ?? P(),
            s = {
              ...
              stat_has: {},
              stat_exp: 0,
              locks: { stat: new Lt.RWLock(), members: new Lt.RWLock() },
            }
          return (this.entries[t] = s), s
        }
        assoc_path(e, t) {
            ...
            readdir: async function (e) {
              ...
              if (t && t.members && t.members_exp > Date.now()) {
                ...
                for (const s of t.members) {
                  ...
                  console.log("PUSHING", t.stat), n.push(t.stat)
                }
                s.unlock()
              }
              if ((console.log("STATS????", n), n)) return n
              t && (s = await t.locks.members.wlock())
              const r = await this.delegate.readdir(e)
              t ||
              ...
              for (const t of r) {
                ...
                s ||
                  ((s = this.cacheFS.add_entry({ id: t.uid })),
              ...
              t.members = []
              for (const e of i) t.members.push(e)
              return (
      ...
      class _s extends e.AdvancedBase {
        ...
        static IMPLEMENTS = {
          [fs]: {
            ...
            readdir: async function (t) {
              const s = new e.libs.promise.TeePromise(),
                n = this.rpc.registerCallback((e) => {
                  s.resolve(e)
                })
              return (
                this.messageTarget.postMessage(
                  { $: "puter-fs", $callback: n, op: "readdir", args: t },
                  "*"
                ),
                await s
              )
      ...
      class ks extends e.concepts.Service {
        static PROPERTIES = {}
        ...
        init_top_fs_() {
          ...
          ;(this.fs_nocache_ = new ys({ api_info: e }).as(fs)),
            (this.fs_cache_ = new ws({ delegate: this.fs_nocache_ }).as(fs)),
            (this.fs_proxy_ = new ms({ delegate: this.fs_nocache_ })),
            (this.filesystem = this.fs_proxy_.as(fs))
        }
        cache_on() {
        ...
        async initializeSocket() {
          ...
          const e = this._.context.services.get("api-access").get_api_info()
          void 0 !== e.api_origin &&
            ((this.socket = dt(e.api_origin, {
              auth: { auth_token: e.auth_token },
              autoUnref: "nodejs" === this._.context.env,
            })),
            this.bindSocketEvents())
        }
        bindSocketEvents() {
      ...
      class Ts extends e.concepts.Service {
        async _init() {
          const e = this._.context.services,
            t = this._.context.util
          e.get("xd-incoming").register_tagged_listener("puter-fs", (e) => {
            t.rpc.send(e.source, e.data.$callback, [As])
          })
        }
      }
      class xs extends e.concepts.Service {
        _init() {
          if (
            globalThis.when_puter_happens &&
            (!puter || "gui" === puter.env)
          ) {
            Array.isArray(globalThis.when_puter_happens) ||
              (globalThis.when_puter_happens = [globalThis.when_puter_happens])
            for (const e of globalThis.when_puter_happens)
              e({ context: this._.context })
          }
        }
      }
      const Is = e.libs.promise.TeePromise
      class Es extends e.concepts.Service {
        _construct() {
      ...
      const Ss = (function () {
        const s = new (class {
          ...
          initSubmodules = function () {
            ;(this.util = new hs()),
              this.registerModule("auth", W),
              this.registerModule("os", Qt),
              this.registerModule("fs", Dt),
              this.registerModule("ui", is, {
                appInstanceID: this.appInstanceID,
                parentInstanceID: this.parentInstanceID,
              }),
              this.registerModule("hosting", Rt),
              this.registerModule("apps", z),
              this.registerModule("ai", F),
              this.registerModule("kv", qt),
              this.registerModule("threads", $t),
              this.registerModule("perms", Zt),
              this.registerModule("drivers", K),
              this.registerModule("debug", X),
              (this.path = c)
          }
          constructor() {
            ;(this._cache = new t({ dbName: "puter_cache" })),
              (this._opscache = new t()),
              (this.modules_ = [])
            const s = new e.libs.context.Context().follow(this, [
              "env",
              "util",
              "authToken",
              "APIOrigin",
            ...
            ;(s.puter = this),
              (this.services = new e.system.ServiceManager({ context: s })),
              (this.context = s),
              (s.services = this.services)
            let r = new URLSearchParams(globalThis.location?.search)
            r.has("puter.app_instance_id")
              ? (this.env = "app")
              ...
              r.has("puter.args")
                ? (this.args = JSON.parse(
                    decodeURIComponent(r.get("puter.args"))
                  ))
                : (this.args = {}),
              r.has("puter.app_instance_id") &&
              ...
              r.has("puter.parent_instance_id") &&
                (this.parentInstanceID = decodeURIComponent(
                  r.get("puter.parent_instance_id")
                )),
              r.has("puter.app.id") &&
                (this.appID = decodeURIComponent(r.get("puter.app.id"))),
              r.has("puter.app.name") &&
                (this.appName = decodeURIComponent(r.get("puter.app.name"))),
              this.appID && (this.appDataPath = `~/AppData/${this.appID}`),
              (this.APIOrigin = this.defaultAPIOrigin),
              r.has("puter.api_origin") && "app" === this.env
                ? (this.APIOrigin = decodeURIComponent(
                    r.get("puter.api_origin")
                  ))
                : r.has("puter.domain") &&
                  "app" === this.env &&
                  (this.APIOrigin = "https://api." + r.get("puter.domain"))
            let i = new e.libs.log.ConsoleLogger()
            i = new e.libs.log.CategorizedToggleLogger({ delegate: i })
            const o = i
            if (
              ((this.logger = new e.libs.log.LoggerFacade({ impl: i, cat: o })),
              (this.apiCallLogger = new n({ enabled: !1 })),
              this.services.register("no-puter-yet", xs),
              this.services.register("filesystem", ks),
              this.services.register("api-access", gs),
              this.services.register("xd-incoming", Es),
              "app" !== this.env && this.services.register("fs-relay", Ts),
              (async () => {
              ...
              ;(this.authToken = decodeURIComponent(r.get("puter.auth.token"))),
                this.initSubmodules()
              try {
              ...
              ("web-worker" !== this.env &&
                "service-worker" !== this.env &&
                "nodejs" !== this.env) ||
                this.initSubmodules()
            ;(async () => {
              await this.services.wait_for_init(["api-access"])
              const t = await this.auth.whoami()
              ;(i = new e.libs.log.PrefixLogger({
                delegate: i,
                prefix:
                  "[" + (t?.app_name ?? this.appInstanceID ?? "HOST") + "] ",
              })),
                (this.logger.impl = i)
            })(),
              ...
              (this.workers = new ds(this.authToken)),
          ...
          setAuthToken = function (e) {
            ...
            "gui" === this.env && setInterval(Ss.checkAndUpdateGUIFScache, 1e4),
            ...
            return (
              (t =
                "object" == typeof e[0] && null !== e[0]
                  ...
                  : { success: e[0], error: e[1] }),
              new Promise((e, s) => {
                const n = O("/whoami", this.APIOrigin, this.authToken, "get")
                D(n, t.success, t.error, e, s), n.send()
              })
            )
          }
          ...
          configureAPILogging = function (e = {}) {
            return (
              this.apiCallLogger && this.apiCallLogger.updateConfig(e), this
            )
          }
          enableAPILogging = function (e = {}) {
            return (
              this.apiCallLogger &&
                this.apiCallLogger.updateConfig({ ...e, enabled: !0 }),
              this
            )
          }
          ...
          checkAndUpdateGUIFScache = function () {
            if ("gui" !== Ss.env) return
            if (!Ss.whoami) return
            let e = Ss.whoami.username,
              t = `/${e}`,
              s = `/${e}/Desktop`,
              n = `/${e}/Documents`,
              r = `/${e}/Public`
            Ss._cache.get("item:" + t) ||
              (console.log(`/${e} item is not cached, refetching cache`),
              Ss.fs.stat(t)),
              Ss._cache.get("item:" + s) ||
                (console.log(
                  `/${e}/Desktop item is not cached, refetching cache`
                ),
                Ss.fs.stat(s)),
              Ss._cache.get("item:" + n) ||
                (console.log(
                  `/${e}/Documents item is not cached, refetching cache`
                ),
                Ss.fs.stat(n)),
              Ss._cache.get("item:" + r) ||
                (console.log(
                  `/${e}/Public item is not cached, refetching cache`
                ),
                Ss.fs.stat(r)),
              Ss._cache.get("readdir:" + t) ||
                (console.log(`/${e} is not cached, refetching cache`),
                Ss.fs.readdir(t)),
              Ss._cache.get("readdir:" + s) ||
                (console.log(`/${e}/Desktop is not cached, refetching cache`),
                Ss.fs.readdir(s)),
              Ss._cache.get("readdir:" + n) ||
                (console.log(`/${e}/Documents is not cached, refetching cache`),
                Ss.fs.readdir(n)),
              Ss._cache.get("readdir:" + r) ||
                (console.log(`/${e}/Public is not cached, refetching cache`),
                Ss.fs.readdir(r))
          }
        })()
        return s
      ...
      ;(globalThis.puter = Ss),
        globalThis.addEventListener &&
          globalThis.addEventListener("message", async (e) => {
            e.origin === Ss.defaultGUIOrigin &&
              (e.data.msg && "requestOrigin" === e.data.msg
                ? e.source.postMessage({ msg: "originResponse" }, "*")
                : "puter.token" === e.data.msg &&
                  (Ss.setAuthToken(e.data.token),
                  Ss.setAppID(e.data.app_uid),
                  (Ss.puterAuthState.authGranted = !0),
                  Ss.onAuth &&
                    "function" == typeof Ss.onAuth &&
                    Ss.getUser().then((e) => {
                      Ss.onAuth(e)
                    }),
                  (Ss.puterAuthState.isPromptOpen = !1),
                  Ss.puterAuthState.resolver &&
                    (Ss.puterAuthState.authGranted
                      ? Ss.puterAuthState.resolver.resolve()
                      : Ss.puterAuthState.resolver.reject(),
                    (Ss.puterAuthState.resolver = null))))
          })
    })()
})()
